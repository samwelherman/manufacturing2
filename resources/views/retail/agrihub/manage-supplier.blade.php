                                        ...
                                        <tbody>
                                           ...
                                           <td> {{$row->address}}</td>                         
                                             ...
                                             <a class="list-icons-item text-primary"
                                                        href="{{ route("retail_supplier.edit", $row->id)}}">
                                                        <i    class="icon-pencil7"></i>
                                                    </a>
                                        </div>&nbsp
                                  <div class = "input-group"> 
         {!! Form::open(['route' => ['retail_supplier.destroy',$row->id], 'method' => 'delete']) !!}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                            @if(isset($id))
                                                    {{ Form::model($id, array('route' => array('retail_supplier.update', $id), 'method' => 'PUT')) }}
                                                    @else
                                                    {{ Form::open(['route' => 'retail_supplier.store']) }}
                                                    @method('POST')
                                                    @endif
