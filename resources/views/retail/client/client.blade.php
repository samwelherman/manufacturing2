                                        ...
                                        <tbody>
                                           ...
                                           <td> {{$row->address}}</td>                         
                                              ...
                                              <a class="list-icons-item text-primary"
                                                        href="{{ route("retail_client.edit", $row->id)}}"><i
                                                            class="icon-pencil7"></i>
                                                    </a>
                                        </div>&nbsp
                                  <div class = "input-group"> 
         {!! Form::open(['route' => ['retail_client.destroy',$row->id], 'method' => 'delete']) !!}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                            @if(isset($id))
                                                    {{ Form::model($id, array('route' => array('retail_client.update', $id), 'method' => 'PUT')) }}
                                                    @else
                                                    {{ Form::open(['route' => 'retail_client.store']) }}
                                                    @method('POST')
                                                    @endif
