                                            ...
                                            <tr class="gradeA even" role="row">
                                               ...
                                               @if($row->type == 'Batch')
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('retail_purchase.show',$row->id)}}" role="tab"
                                                            aria-selected="false">{{$row->reference_no}}</a>
                                                       @else
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('retail_purchase_serial.show',$row->id)}}" role="tab"
                                                            aria-selected="false">{{$row->reference_no}}</a>
                                                    @endif
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    @php    
                                                    $loc=App\Models\Retail\Location::where('id', $row->location)->get();   
                                                  @endphp
                                                     @foreach($loc as $l)
                                                    {{$l->name}}
                                                    @endforeach
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($row->status == 6)
                                                    <span class="badge badge-success badge-shadow">Scanned and Paid</span>
                                                ...
                                                <td>
                                                  @if($row->type == 'Batch')
                                                    ...
                                                    <a class="list-icons-item text-primary"
                                                        ...
                                                        href="{{ route('retail_purchase.edit', $row->id)}}"><i
                                                            class="icon-pencil7"></i></a>&nbsp
                                                          

                                                    {!! Form::open(['route' => ['retail_purchase.destroy',$row->id],
                                                    'method' => 'delete']) !!}
...
&nbsp
                                                ...
                                                <div class="dropdown">
							                		<a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                                           ...
                                                           <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('retail_purchase.pay',$row->id)}}"
                                                      ...
                                                      <li class="nav-item"><a class="nav-link" title="PDF"
                                                                   href="{{ route('retail_purchase_pdfview',['download'=>'pdf','id'=>$row->id]) }}">Download PDF</a></li>
                                                       </div>
					                			</div>
                                                 ...
                                                 @else
                                                    ...
                                                    <a class="list-icons-item text-primary"
                                                        title="Edit" onclick="return confirm('Are you sure?')"
                                                        href="{{ route('retail_purchase_serial.edit', $row->id)}}"><i
                                                            class="icon-pencil7"></i></a>&nbsp
                                                          

                                                    {!! Form::open(['route' => ['retail_purchase_serial.destroy',$row->id],
                                                    'method' => 'delete']) !!}
                                                    {{ Form::button('<i class="icon-trash"></i>', ['type' => 'submit', 'style' => 'border:none;background: none;', 'class' => 'list-icons-item text-danger', 'title' => 'Delete', 'onclick' => "return confirm('Are you sure?')"]) }}
                                                    {{ Form::close() }}
  @endif
&nbsp
                                                ...
                                                <div class="dropdown">
                                                    <a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                                           ...
                                                           <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('retail_purchase_serial.pay',$row->id)}}"
                                                                    role="tab"
                                                                    aria-selected="false">Make Payments</a>
                                                            
                                                            @endif
                                                   <li class="nav-item"><a class="nav-link" title="PDF"
                                                                   href="{{ route('retail_serial_purchase_pdfview',['download'=>'pdf','id'=>$row->id]) }}">Download PDF</a></li>
                                                       </div>
                                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('retail_purchase.update', $id), 'method' => 'PUT')) }}
                                              
                                                @else
                                                {{ Form::open(['route' => 'retail_purchase.store']) }}
                                                @method('POST')
                                                @endif
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        ...
                                                        <a class="btn btn-sm btn-danger float-right m-t-n-xs"
                                                            href="{{ route('retail_purchase.index')}}">
                                                            cancel
                                                        </a>
                           ...
                           <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($serial))
                                                {{ Form::model($serial, array('route' => array('retail_purchase_serial.update', $serial), 'method' => 'PUT')) }}
                                              
                                                @else
                                                {{ Form::open(['route' => 'retail_purchase_serial.store']) }}
                                                @method('POST')
                                                @endif
...
$(document).ready(function() {
    ...
    $(document).on('change', '.item_name', function() {
        ...
        $.ajax({
            url: '{{url("pos/retail_purchases/retail_findInvPrice")}}',
            type: "GET",
            data: {
                id: id
            },
...
function saveSupplier(e) {
   ...
   var TIN= $('#TIN').val();
          ...
          $.ajax({
            type: 'GET',
            url: '{{url("pos/retail_purchases/addSupplier")}}',
             data: {
                 'name':name,
                 'phone':phone,
                 'email':email,
