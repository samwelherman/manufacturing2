                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                     @if(isset($id))
                                                {{ Form::model($id, array('route' => array('retail_items.update', $id), 'method' => 'PUT')) }}
                                                @else
                                                {{ Form::open(['route' => 'retail_items.store']) }}
                                                @method('POST')
                                                @endif
...
-->
 ...
 <div class="tab-pane fade" id="importExel" role="tabpanel"
                            ...
                            <div class="card">
                                <div class="card-header">
                                     <form action="{{ route('retail.sample') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 ">
                                            <div class="container mt-5 text-center">
                                                ...
                                                <form action="{{ route('retail.import') }}" method="POST" enctype="multipart/form-data">
...
<script>
$(function() {
    let urlcontract = "{{ route('retail_items.index') }}";
...
function deleteItem(id) {
 var url = '{{ route("retail_items.destroy", ":id") }}';
...
function saveCategory(e) {
     ...
     var name = $('#name').val();
          ...
          $.ajax({
            type: 'GET',
            url: '{{url("pos/retail_purchases/addCategory")}}',
             data: {
                 'name':name,
