                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('retail_credit_note.show',$row->id)}}" role="tab"
                                            ...
                                            <div class="form-inline">
                                                    ...
                                                    <a class="list-icons-item text-primary"
                                                        ...
                                                        href="{{ route('retail_credit_note.edit', $row->id)}}"><i
                                                            class="icon-pencil7"></i></a>&nbsp
                                                            @endif

                                                    {!! Form::open(['route' => ['retail_credit_note.destroy',$row->id],
                                                    'method' => 'delete']) !!}
                                 ...
                                 &nbsp
                                       ...
                                       <div class="dropdown-menu">
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('retail_credit_note.receive',$row->id)}}"
                                                                    role="tab"
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('retail_credit_note.pay',$row->id)}}"
                                                                    role="tab"
                                                            ...
                                                            <li class="nav-item"><a class="nav-link" title="Cancel"
                                                                    ...
                                                                    href="{{ route('retail_credit_note.cancel', $row->id)}}">Cancel
                                                                  Credit Note</a></li>
                                        @endif
                                   <li class="nav-item"><a class="nav-link" title="PDF"
                                                                    href="{{ route('retail_credit_note_pdfview',['download'=>'pdf','id'=>$row->id]) }}">Download PDF</a></li>
                                       </div>
                                       </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('retail_credit_note.update', $id), 'method' => 'PUT')) }}
                                              
                                                @else
                                                {{ Form::open(['route' => 'retail_credit_note.store']) }}
                                                @method('POST')
                                                @endif
                                                ...
                                                <table class="table table-bordered" id="cart">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($items as $i)
                                                         ...
                                                         <?php
                                                              $inv= App\Models\Retail\InvoiceItems::find($i->return_item);
                                                              if($inv->category == 'Batch'){
                                                               $date = today()->format('Y-m-d');                                                               
           $name=App\Models\Retail\PurchaseHistory::where('item_id',$inv->type)->where('expire_date', '>', $date)->where('added_by',auth()->user()->added_by)->orderBy('expire_date', 'ASC')->get();
                                                             
                                                               }

                                                      else if($inv->category == 'Serial'){
                                                            $name=App\Models\Retail\PurchaseSerialList::where('added_by',auth()->user()->added_by)->get();  
                                                              $due=1; 
                                                            }
                                                              ?>
                                                        <tr class="line_items">
...
console.log(id);
        $.ajax({
            url: '{{url("pos/retail_sales/retail_findinvoice")}}',
            type: "GET",
            data: {
                id: id
            },
...
console.log(id);
        $.ajax({
            url: '{{url("pos/retail_sales/retail_editshowInvoice")}}',
            type: "GET",
            data: {
                id: id,
            },
...
console.log(id);
        $.ajax({
            url: '{{url("pos/retail_sales/retail_findinvQty")}}',
            type: "GET",
            data: {
                id: id,
              item: item,
