                                  ...
                                  <table class="table datatable-basic table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                   @if($row->type == 'Batch')
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('retail_invoice.show',$row->id)}}" role="tab"
                                                ...
                                                @php $store_location =  App\Models\Retail\Location::find(auth()->user()->store_id)->name;  @endphp
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($row->status == 6)
                                                    <span class="badge badge-danger badge-shadow">Scanned</span>
                                                    
                                                    @elseif($row->status == 7)
                                                    <span class="badge badge-danger badge-shadow">Paid</span>
                                            ...
                                            <div class="form-inline">
                                                    ...
                                                    <a class="list-icons-item text-primary"
                                                        ...
                                                        href="{{ route('retail_invoice.edit', $row->id)}}"><i
                                                            class="icon-pencil7"></i></a>&nbsp
                                                          

                                                    {!! Form::open(['route' => ['retail_invoice.destroy',$row->id],
                                                    'method' => 'delete']) !!}
                                                ...
                                                <div class="dropdown">
													...
													<div class="dropdown-menu">
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('retail_invoice.receive',$row->id)}}"
                                                                    role="tab"
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('retail_pos_invoice.pay',$row->id)}}"
                                                                    role="tab"
                                                            ...
                                                            <li class="nav-item"><a class="nav-link" title="Cancel"
                                                                    ...
                                                                    href="{{ route('retail_invoice.cancel', $row->id)}}">Cancel
                                                                  Invoice</a></li>
                                        @endif

                                                               <li class="nav-item"><a class="nav-link" title="PDF"
                                                                   href="{{ route('retail_pos_invoice_pdfview',['download'=>'pdf','id'=>$row->id]) }}">Download PDF</a></li>

                                                           @if($row->good_receive == 1)
                                                            <li class="nav-item"><a class="nav-link" title="Delivery Note"
                                                                    href="{{ route('retail_pos_note_pdfview',['download'=>'pdf','id'=>$row->id]) }}">Download DN</a></li>

                                                                    @if($row->attach_delivery != '')
                                                            <li class="nav-item"><a class="nav-link" title="Delivery Note"
                                                                    href="{{ route('retail_invoice.delivery',$row->id) }}">Download Signed DN</a></li>
                                                            @else
                                                                 <li class="nav-item"><a class="nav-link" title="Delivery Note"
                                                    ...
                                                    onclick="model({{ $row->id }},'batch')">Attach Signed DN</a></li>
                                                           ...
                                                           @if($row->attach_reference != '')
                                                            <li class="nav-item"><a class="nav-link" title="Delivery Note"
                                                                    href="{{ route('retail_invoice.reference',$row->id) }}">Download Order Reference</a></li>
                                                               @endif
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('retail_invoice.update', $id), 'method' => 'PUT',"enctype"=>"multipart/form-data")) }}
                                              
                                                @else
                                                   {!! Form::open(array('route' => 'retail_invoice.store',"enctype"=>"multipart/form-data")) !!}
                                                @method('POST')
                                                @endif
                                                ...
                                                <div class="form-group row">
                                                 ...
                                                 <label class="col-lg-2 col-form-label">Location</label>
                                                    <div class="col-lg-4">
                                                          <select class="form-control m-b location" name="location"   id="location" required >
                   ...
                   @endif
                     ...
                     @endif
                                                ...
                                                <table class="table table-bordered" id="cart">
                                                  ...
                                                  $chk= App\Models\Retail\PurchaseHistory::where('item_id',$i->type)->where('due_quantity','>','0')->where('location',$data->location)->where('added_by',auth()->user()->added_by)->get();

                                                 foreach($chk as $c){
                                                  if($c->expire_date != ''){
            $batch_list= App\Models\Retail\PurchaseHistory::where('item_id',$i->type)->where('due_quantity','>','0')->where('location',$data->location)->where('added_by',auth()->user()->added_by)->where('expire_date', '>', $date)->get();
}

else{
  $batch_list= App\Models\Retail\PurchaseHistory::where('item_id',$i->type)->where('due_quantity','>','0')->where('location',$data->location)->where('added_by',auth()->user()->added_by)->get();
