            ...
            <div class="col-12 col-md-12 col-lg-12">
               ...
               <div class="col-lg-10">
                ...
                @if($invoices->invoice_status == 0)
                 ...
                 <a class="btn btn-xs btn-primary"  onclick="return confirm('Are you sure?')"   href="{{ route('retail_proforma_invoice.edit', $invoices->id)}}"  title="" > Edit </a>        
                 <a class="btn btn-xs btn-success"  href="{{ route('retail_proforma_invoice_pdfview',['download'=>'pdf','id'=>$invoices->id]) }}"  title="" > Download PDF </a>         
