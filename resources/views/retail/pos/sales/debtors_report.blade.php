...
<br>
@php
$center=App\Models\Retail\Client::where('id',$account_id)->first();
@endphp
...
?>
                     ...
                     <a class="nav-link" id="profile-tab2"  href="{{ route('retail_invoice.show',$key->id)}}" role="tab"   aria-selected="false">{{$key->reference_no}}</a>
                            ...
                            <td>{{number_format($invoice_due,2)}} {{$key->exchange_code}}</td>                      
                                           ...
                                           <td> 
                                                  @if($key->status == 1)
                                                    ...
                                                    @elseif($key->status == 5)
                                                    <div class="badge badge-info badge-shadow">Received</div>
                                                    
                                                    @elseif($key->status == 6)
                                                    <div class="badge badge-success badge-shadow">Scanned</div>
