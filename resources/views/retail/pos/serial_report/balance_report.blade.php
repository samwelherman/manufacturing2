            ...
            <div class="col-12 col-sm-6 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Balance Serial Report</h4>
                    </div>
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Balance Serial Report
                                    List</a>
                            </li>
...
?>
                        ...
                        @foreach($data as $key)
                            ...
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                 ...
                                 @php
                                   ...
                                   else if($key->status == 0 || $key->status == 2){                        
                                       $sqty= 0; 
                                      }
                           ...
                           <td>{{number_format($pqty,2)}}</td>
                                 <td>{{number_format($sqty,2)}}</td>     
                              <td>{{number_format($pqty-$sqty,2)}}</td>                          
                            </tr>
                     ...
                     <td></td>
                       ...
                       <td>{{number_format($total_p-$total_s,2)}}</td>                               
                            </tr>
                        </tfoot>
                    </table>
...
@foreach($data as $key)
 ...
 <?php
                        ...
                        $q = App\Models\Retail\InvoiceHistory::where('item_id', $key->id)->sum('quantity');
