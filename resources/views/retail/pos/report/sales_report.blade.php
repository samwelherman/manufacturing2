...
?>
                     ...
                     <td><a  href="#view{{$key->id}}"  data-toggle="modal" >{{$key->name}}</a></td>
                                     @php
                                      $qty= App\Models\Retail\InvoiceHistory::where('item_id', $key->id)->where('type', 'Sales')->sum('quantity'); 
                                         $rn= App\Models\Retail\InvoiceHistory::where('item_id', $key->id)->where('type', 'Credit Note')->sum('quantity');   
                                        $total+=$qty;
                                       $return+=$rn;
                                        @endphp 
