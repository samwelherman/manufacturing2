    ...
    <div class="section-body">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
              ...
              <a class="btn btn-xs btn-info"  title="Convert to Invoice" onclick="return confirm('Are you sure?')"   href="{{ route('purchase_tyre.approve',$purchases->id)}}"  title="" >Approve Purchase </a>
                @endif
      ...
      @if($purchases->status != 0 && $purchases->status != 4 && $purchases->status != 3 && $purchases->good_receive == 0)                        
              <a class="btn btn-xs btn-info" data-placement="top"  href="{{ route('purchase_tyre.receive',$purchases->id)}}"  title="Good Receive"> Good Receive </a>   
           @endif  
                    ...
                    <tr>
                        ...
                        <th class="col-sm-1" style="color:white;">Total</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <td class=""><strong class="block">{{$item_name->brand}}</strong></td>
