                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('purchase_tyre.show',$row->id)}}" role="tab"
...
&nbsp
                                  ...
                                  <a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('purchase_tyre.approve',$row->id)}}"
                                                                    role="tab"
   ...
   @endif
                     ...
                     @endif
                                                ...
                                                <button type="button" name="add" class="btn btn-success btn-xs add"><i
                                                        class="icon-plus3"> </i> Add item</button><br>
                                                <br>
                                                <div class="table-responsive">
                                                        ...
                                                        <tr class="line_items">
                                                            <td><select name="item_name[]"
                                                                    ...
                                                                    as $n) <option value="{{ $n->id}}"
                                                                        ...
                                                                        selected @endif @endif >{{$n->brand}}</option>
                                                                    @endforeach
                                                                </select></td>
...
<div class="modal fade" id="appFormModal" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="form-group row"><label
        ...
        <div class="modal-footer ">
            <button type="submit" class="btn btn-primary" id="save" onclick="saveSupplier(this)"> <i class="icon-checkmark3 font-size-base mr-1"></i> Save</button>
...
$(document).ready(function() {
    ...
    $('.add').on("click", function(e) {
        ...
        html +=
            ...
            count +
            '"><option value="">Select Item</option>@foreach($name as $n) <option value="{{ $n->id}}">{{$n->brand}}</option>@endforeach</select></td>';
        html +=
