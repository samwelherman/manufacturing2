                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-10">
                                <div class="tab-content no-padding" id="myTab2Content">
                                    <div class="tab-pane fade @if($type =='comesa' || $type == 'edit-comesa') active show  @endif" id="tab1"
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link @if($type =='comesa') active show @endif" id="home-tab2"
                                                        data-toggle="tab" href="#home2" role="tab" aria-controls="home"
                                                        aria-selected="true">COMESA List
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link @if($type =='edit-comesa') active show @endif" id="profile-tab2"
                                                        data-toggle="tab" href="#profile2" role="tab" aria-controls="profile"
                                                        aria-selected="false"> New COMESA</a>
                                                </li>

                                              
                                            </ul>
                                            <div class="tab-content tab-bordered" id="myTab3Content">
                                                <div class="tab-pane fade @if($type =='comesa') active show @endif" id="home2" role="tabpanel"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="gradeA even" role="row">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        href="{{ route("comesa.edit", $row->id)}}">
                                                                      <i class="icon-pencil7"></i>
                                                    </a>&nbsp
                                                                    
                                
                                                                    {!! Form::open(['route' => ['comesa.destroy',$row->id],
                                                                    'method' => 'delete']) !!}
...
&nbsp
                                                ...
                                                <div class="tab-pane fade @if($type =='edit-comesa') active show @endif" id="profile2"
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-sm-12 ">
                                                                    @if($type =='edit-comesa')
                                                                    {{ Form::model($id, array('route' => array('comesa.update', $id), 'method' => 'PUT',"enctype"=>"multipart/form-data")) }}
                                                                    @else
                                                                    {{ Form::open(['route' => 'comesa.store',"enctype"=>"multipart/form-data"]) }}
                                                                    @method('POST')
                                                                    @endif
