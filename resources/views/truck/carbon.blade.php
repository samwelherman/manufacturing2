                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-2">
                                ...
                                <li class="nav-item">
                                        <a class="nav-link active" id="#tab5" 
                            ...
                            <div class="col-12 col-sm-12 col-md-10">
                                <div class="tab-content no-padding" id="myTab2Content">
                                    <div class="tab-pane fade @if($type =='carbon' || $type == 'edit-carbon') active show  @endif" id="tab1"
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link @if($type =='carbon') active show @endif" id="home-tab2"
                                                        data-toggle="tab" href="#home2" role="tab" aria-controls="home"
                                                        aria-selected="true">Carbon List
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link @if($type =='edit-carbon') active show @endif" id="profile-tab2"
                                                        data-toggle="tab" href="#profile2" role="tab" aria-controls="profile"
                                                        aria-selected="false"> New Carbon</a>
                                                </li>

                                              
                                            </ul>
                                            <div class="tab-content tab-bordered" id="myTab3Content">
                                                <div class="tab-pane fade @if($type =='carbon') active show @endif" id="home2" role="tabpanel"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="gradeA even" role="row">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        href="{{ route("carbon.edit", $row->id)}}">
                                                                      <i class="icon-pencil7"></i>
                                                    </a>&nbsp
                                                                    
                                
                                                                    {!! Form::open(['route' => ['carbon.destroy',$row->id],
                                                                    'method' => 'delete']) !!}
...
&nbsp
                                                ...
                                                <div class="tab-pane fade @if($type =='edit-carbon') active show @endif" id="profile2"
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-sm-12 ">
                                                                    @if($type =='edit-carbon')
                                                                    {{ Form::model($id, array('route' => array('carbon.update', $id), 'method' => 'PUT',"enctype"=>"multipart/form-data")) }}
                                                                    @else
                                                                    {{ Form::open(['route' => 'carbon.store',"enctype"=>"multipart/form-data"]) }}
                                                                    @method('POST')
                                                                    @endif
