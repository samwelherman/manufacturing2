                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Inventory Report
                                    List</a>
                            </li>
...
-->
   ...
   <div class="col-md-12">
                   ...
                   @if(!empty($account_id))
                        <a class="btn btn-primary" href="{{ route('inventory_report',['account_id'=>isset($account_id)? $account_id : '' ,'type'=>'print_pdf']) }}"  title="" > Download PDF </a>      
                      @endif
