                                    ...
                                    <table class="table datatable-basic table-striped" id="table-1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    @php    
                                                    $it=App\Models\InventoryList::where('id', $row->item_id)->get();   
                                                  @endphp
                                                     @foreach($it as $i)
                                                     {{$i->serial_no}}
                                                    @endforeach
                                                ...
                                                <td>
                                                  ...
                                                  @endphp
                                                    ...
                                                    href="{{ route("disposal.approve", $row->id)}}" title="Approve" onclick="return confirm('Are you sure?')">
                                                    ...
                                                    {!! Form::open(['route' => ['good_disposal.destroy',$row->id],
                                                    'method' => 'delete']) !!}
