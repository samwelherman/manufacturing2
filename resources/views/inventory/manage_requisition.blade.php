                                ...
                                <div class="table-responsive">
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('requisition.show',$row->id)}}" role="tab"
                                             ...
                                             <div class="form-inline">
                                                 <a class="list-icons-item text-primary"
                                                        title="Edit" onclick="return confirm('Are you sure?')"
                                                         href="{{ route('requisition.edit', $row->id)}}"><i
                                                   &nbsp
                                  ...
                                  <a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                                            ...
                                                            <li class="nav-item"> <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('requisition.receive',$row->id)}}"
                                                                    role="tab"
                                                            ...
                                                            <li class="nav-item"><a class="nav-link" title="Cancel"
                                                                    ...
                                                                    href="{{ route('requisition.cancel', $row->id)}}">Cancel
                                                                   Purchase</a></li>
