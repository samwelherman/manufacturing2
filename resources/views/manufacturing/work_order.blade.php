                            ...
                            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link @if (empty($id)) active show @endif" id="home-tab2"
                                        ...
                                        aria-selected="true">Production Order
                                        List</a>
                                </li>
                                <li class="nav-item">
                                                            ...
                                                            <td>
                                                                <div class="form-inline">
                                                                    @if ($row->status == 0)
                                                                        ...
                                                                        {!! Form::open(['route' => ['work_order.destroy', $row->id], 'method' => 'delete']) !!}
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @elseif($row->status == 2)
                                                                                <li><a class="nav-link" href=""
                                                                                        ...
                                                                                        onclick="model({{ $row->id }},'produce')">Produce</a>
                                                                                </li>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 ">
                                                    ...
                                                    <div class="form-group row"><label
                                                            class="col-lg-2 col-form-label">Shift</label>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(key, value) {
                            ...
                            $("#class").append('<option value=' + value.id + '>' + value
                                .class + '</option>');
