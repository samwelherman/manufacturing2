                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Product 
                                    List</a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                     @if(isset($id))
                                                {{ Form::model($id, array('route' => array('product_items.update', $id), 'method' => 'PUT')) }}
                                                @else
                                                ...
                                                <option value="">Select</option>
                                                        ...
                                                        <option value="2" {{ isset($data) ? ($data->type == 2 ? "selected":'') : ''}}>Manufactured Product</option>
