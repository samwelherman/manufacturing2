...
@section('content')
                            ...
                            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link @if (empty($id)) active show @endif" id="home-tab2"
                                        ...
                                        aria-selected="true">Bill Of Material List</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link @if (!empty($id)) active show @endif"
                                        id="profile-tab2" data-toggle="tab" href="#profile2" role="tab"
                                        aria-controls="profile" aria-selected="false">New Bill Of Material</a>
                                </li>
                                                        ...
                                                        <tr class="gradeA even" role="row">
                                                            ...
                                                            <td>
                                                                <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('bill_of_material.show', $row->id) }}"
                                                                    role="tab"
                                                            ...
                                                            <td>
                                                                <div class="form-inline">
                                                                    ...
                                                                    {!! Form::open(['route' => ['bill_of_material.destroy', $row->id], 'method' => 'delete']) !!}
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-12 ">
                                                    @if (isset($id))
                                                        {{ Form::model($id, ['route' => ['bill_of_material.update', $id], 'method' => 'PUT']) }}
                                                    @else
                                                ...
                                                value="{{$type}}" /> --}}
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-lg-4 col-form-label">Enter Description Of Bill of
                                                            Material</label>
                                                        <div class="col-lg-8">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-lg-4 col-form-label">Products For
                                                            Manufacture</label>
                                                        <div class="col-lg-8">
                                                            <select class="form-control m-b" name="product" required
                                                                ...
                                                                @if (!empty($products))
                                                                    @foreach ($products as $row)
                                                                        <option
                                                                            @if (isset($data)) {{ $data->product == $row->id ? 'selected' : '' }} @endif
                                                                            value="{{ $row->id }}">
                                                                            {{ $row->name }}</option>
                                                                    @endforeach
                                                                @endif
    ...
    <option @if (isset($data)) {{ $data->location_id == $row->id ? 'selected' : '' }} @endif value="{{ $row->id }}">{{ $row->name }}</option>
    @endforeach
                                                                    @endif
