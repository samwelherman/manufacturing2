                         ...
                         <a class="nav-link @if($type == 'details' || $type == 'comments' || $type == 'attachment' || $type == 'tasks' || $type == 'notes' || $type == 'activities' ) active  @endif" id="home-tab2" data-toggle="tab"
                                                ...
                                                <div class="tab-content tab-bordered" id="myTab3Content">
                                                    <div class="tab-pane fade @if($type == 'details' || $type == 'comments' || $type == 'attachment' || $type == 'tasks' || $type == 'notes' || $type == 'activities' ) active show  @endif " id="notes-home2" role="tabpanel"
                                     ...
                                     <a class="list-icons-item text-primary" title="Edit"  href="{{route('edit.task_details',['type'=>'edit-notes','type_id'=>$row->id])}}"><i class="icon-pencil7"></i></a>&nbsp
                                  <a class="list-icons-item text-danger" title="Edit"  href="{{route('delete.task_details',['type'=>'delete-notes','type_id'=>$row->id])}}" onclick= "return confirm('Are you sure, you want to delete?')"><i class="icon-trash"></i></a>&nbsp
