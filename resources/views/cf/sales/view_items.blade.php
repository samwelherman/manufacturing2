                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="line_items">
                                                            <td><select name="item_name[]"
                                                                    class="form-control  m-b crd-item_name" required
                                                                   disabled>
                                                            ...
                                                            <td><input type="number" name="quantity[]"
                                                                    ...
                                                                    required />
                                                                   <div class=""> <p class="form-control-static crd-errors{{$i->order_no}}" id="errors" style="text-align:center;color:red;"></p>   </div> 
                                                                           </td>
                                                         ...
                                                         <input type="hidden" name="id[]" id="item"
                                                                class="form-control crd-id{{$i->order_no}}"
                                                                value="{{ isset($i) ? $i->id : ''}}" />
                                                            <td><button type="button" name="remove"
                                                                    class="btn btn-danger btn-xs crd-remove"
...
$(document).ready(function() {
    ...
    $(document).on('click', '.crd-remove', function() {
