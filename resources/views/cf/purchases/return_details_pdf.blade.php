                    ...
                    <td class="w-50">
                        <div class="box-text">
                            <p> <strong>Reference : {{$invoices->reference_no}}</strong></p>
                                <p> <strong>Return from Purchase No : {{$invoices->purchase->reference_no}}</strong></p>
                                    <p> <strong>Return Date : {{Carbon\Carbon::parse($invoices->return_date)->format('d/m/Y')}}</strong></p>
                                </div>
                            </td>
                        </tr>
                </tfoot>
...
<tbody>
        ...
        <tr>
            ...
            <td>
                <div class="box-text">
                    <p>{{$invoices->supplier->name}}</p>
                    <p>{{$invoices->supplier->address}}</p>
                     <p>Contact : {{$invoices->supplier->phone}}</p>
                 <p>Email: <a href="mailto:{{$invoices->supplier->email}}">{{$invoices->supplier->email}}</p>
                    <p>TIN : {{!empty($invoices->supplier->TIN)? $invoices->supplier->TIN : ''}}</p>
                </div>
            </td>
        </tr>
</tbody>
