                                            ...
                                            <tr role="row">
                                             ...
                                             <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 121.219px;">Truck</th>                                              
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                            ...
                                            <div class="form-inline">
                                               ...
                                               <a class="list-icons-item text-success"
                                                  ...
                                                  {{ Form::button('<i class="icon-trash"></i>', ['type' => 'submit', 'style' => 'border:none;background: none;', 'class' => 'list-icons-item text-danger', 'title' => 'Delete', 'onclick' => "return confirm('Are you sure?')"]) }}
                                                    ...
                                                    @else
                                                    <a class="nav-link"
                                                        href="{{ route("pos_issue.edit", $row->id)}}"  data-toggle="modal" href=""  value="{{ $row->id}}" data-type="issue" data-target="#appFormModal"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                     @if(isset($id))
                                                {{ Form::model($id, array('route' => array('pos_issue.update', $id), 'method' => 'PUT')) }}
                                                @else
                                 ...
                                 <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <option @if(isset($data))
                                                            {{ $data->location == $row->location_id  ? 'selected' : ''}}
                                                            @endif value="{{$row->location_id}}">{{$row->name}}</option>
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr class="line_items">
                                                        ...
                                                        <td><select name="item_id[]"
                                                            class="form-control m-b item_name"  data-sub_category_id="{{$i->order_no}}_qty" required
                                                            >
                                                  ...
                                                  <td><input type="number" name="quantity[]"
                                                            class="form-control item_quantity" data-category_id="{{$i->order_no}}_qty"
                                                    ...
                                                    <input type="hidden" id="item_id"  class="form-control item_id{{$i->order_no}}_qty" value="{{$i->item_id}}" />
