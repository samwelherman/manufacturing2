                         ...
                         <a class="nav-link  @if($type == 'credit' || $type == 'details' || $type == 'calendar' || $type == 'purchase' || $type == 'debit' || $type == 'invoice' || $type == 'comments' || $type == 'attachment' || $type == 'milestone' || $type == 'tasks' || $type == 'expenses' || $type == 'estimate' || $type == 'notes'  || $type =='logistic'  || $type =='cargo' || $type =='storage' || $type =='charge' || $type == 'activities' )  active  @endif" id="home-tab2" data-toggle="tab"
                                                ...
                                                <div class="tab-content tab-bordered" id="myTab3Content">
                                                    <div class="tab-pane fade @if($type == 'credit' || $type == 'details' || $type == 'calendar' || $type == 'purchase' || $type == 'debit' || $type == 'invoice' || $type == 'comments' || $type == 'attachment' || $type == 'milestone' || $type == 'tasks' || $type == 'expenses' || $type == 'estimate' || $type == 'notes' || $type == 'activities' )  active show  @endif " id="task-home2" role="tabpanel"
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    style="width: 98.1094px;">Actions</th>
                                                             ...
                                                             <td><a  href="{{ route("cf_task.show",$row->id)}}">{{$row->task_name}}</a></td>
                                                @php $category = App\Models\CF\TaskCategory::find($row->category_id);  @endphp
                                                <td>{{$category->name}}</td>
                                     ...
                                     <a class="list-icons-item text-primary" title="Edit"  href="{{route('edit.cf_details',['type'=>'edit-tasks','type_id'=>$row->id])}}"><i class="icon-pencil7"></i></a>&nbsp
                                  <a class="list-icons-item text-danger" title="Edit"  href="{{route('delete.cf_details',['type'=>'delete-tasks','type_id'=>$row->id])}}" onclick= "return confirm('Are you sure, you want to delete?')"><i class="icon-trash"></i></a>&nbsp
                                    ...
                                    <br>
                                        ...
                                        @endif
                                                    ...
                                                    <input type="checkbox" name="select_all"  id="example-select-all"> Select All<br> 
                                                            ...
                                                            <input name="trans_id[]" type="checkbox"  class="checks" value="{{$row->id}}"> {{$row->name}} &nbsp;
