...
<!--
 <li class="nav-item">
                                <a class="nav-link @if(!empty($serial)) active show @endif  " id="importExel-tab"
                                    ...
                                    aria-selected="false">Purchase with Serial No</a>
                            </li>
-->                      
                                            ...
                                            <tr class="gradeA even" role="row">
                                               ...
                                               @if($row->type == 'Batch')
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('pharmacy_purchase.show',$row->id)}}" role="tab"
                                                            aria-selected="false">{{$row->reference_no}}</a>
                                                       @else
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('pharmacy_purchase_serial.show',$row->id)}}" role="tab"
                                                            aria-selected="false">{{$row->reference_no}}</a>
                                                    @endif
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                  @if($row->type == 'Batch')
                                                    ...
                                                    <a class="list-icons-item text-primary"
                                                        ...
                                                        href="{{ route('pharmacy_purchase.edit', $row->id)}}"><i
                                                            class="icon-pencil7"></i></a>&nbsp
                                                          

                                                    {!! Form::open(['route' => ['pharmacy_purchase.destroy',$row->id],
                                                    'method' => 'delete']) !!}
...
&nbsp
                                                ...
                                                <div class="dropdown">
							                		<a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                                            ...
                                                            @if($row->status == 0)
                                                           <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('pharmacy_purchase.receive',$row->id)}}"
                                                                    role="tab"
                                                           ...
                                                           @if($row->status != 0 && $row->good_receive == 0)
                                                             <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('pharmacy_purchase.approve',$row->id)}}"
                                                                    role="tab"   onclick="return confirm('Are you sure?')"
                                                                    aria-selected="false">Good Receive</a>
                                                          
                                                            @endif
                                                             @if($row->status == 1 || $row->status == 2)
                                                           <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('pharmacy_purchase.pay',$row->id)}}"
                                                                    role="tab"   onclick="return confirm('Are you sure?')"
                                                            ...
                                                            <a class="nav-link" title="Cancel"
                                                                    ...
                                                                    href="{{ route('pharmacy_purchase.cancel', $row->id)}}">Cancel
                                                                   Purchase</a>
                                        @endif
                                                      <li class="nav-item"><a class="nav-link" title="PDF"
                                                                   href="{{ route('pharmacy_purchase_pdfview',['download'=>'pdf','id'=>$row->id]) }}">Download PDF</a></li>
                                                       </div>
					                			</div>
                                                 ...
                                                 @else
                                                    ...
                                                    <a class="list-icons-item text-primary"
                                                        title="Edit" onclick="return confirm('Are you sure?')"
                                                        href="{{ route('pharmacy_purchase_serial.edit', $row->id)}}"><i
                                                            class="icon-pencil7"></i></a>&nbsp
                                                          

                                                    {!! Form::open(['route' => ['pharmacy_purchase_serial.destroy',$row->id],
                                                    'method' => 'delete']) !!}
                                                    {{ Form::button('<i class="icon-trash"></i>', ['type' => 'submit', 'style' => 'border:none;background: none;', 'class' => 'list-icons-item text-danger', 'title' => 'Delete', 'onclick' => "return confirm('Are you sure?')"]) }}
                                                    {{ Form::close() }}
  @endif
&nbsp
                                                ...
                                                <div class="dropdown">
                                                    <a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                                            ...
                                                            @if($row->status == 0)
                                                           <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('pharmacy_purchase_serial.approve',$row->id)}}"
                                                                    role="tab"
                                                                    aria-selected="false" onclick="return confirm('Are you sure?')">Approve Purchase</a>
                                                            ...
                                                            @if($row->status != 0 && $row->status != 4 && $row->status != 3 && $row->good_receive == 0)
                                                             <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('pharmacy_purchase_serial.receive',$row->id)}}"
                                                                    role="tab"
                                                                    aria-selected="false">Good Receive</a>
                                                           ...
                                                           <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('pharmacy_purchase_serial.pay',$row->id)}}"
                                                                    role="tab"
                                                                    aria-selected="false">Make Payments</a>
                                                            ...
                                                            <a class="nav-link" title="Cancel"
                                                                    onclick="return confirm('Are you sure?')"
                                                                    href="{{ route('pharmacy_purchase_serial.cancel', $row->id)}}">Cancel
                                                                   Purchase</a>
                                        @endif
                                                   <li class="nav-item"><a class="nav-link" title="PDF"
                                                                   href="{{ route('pharmacy_serial_purchase_pdfview',['download'=>'pdf','id'=>$row->id]) }}">Download PDF</a></li>
                                                       </div>
                                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('pharmacy_purchase.update', $id), 'method' => 'PUT')) }}
                                              
                                                @else
                                                {{ Form::open(['route' => 'pharmacy_purchase.store']) }}
                                                @method('POST')
                                                @endif
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <tr class="line_items">
                                                            ...
                                                            <td><input type="number" name="quantity[]"
                                                                    ...
                                                                    required /></td>
<!--
                                                            <td><input type="text" name="batch_number[]"
                                                                    class="form-control item_batch_number{{$i->order_no}}"
                                                                    placeholder="Batch No#"
                                                                    value="{{ isset($i) ? $i->batch_number : ''}}"
                                                                    required /></td>
                                     
                                                            <td><input type="month" name="expire_date[]"
                                                                    class="form-control item_monthyear{{$i->order_no}}"
                                                                    placeholder="Expires"
                                                                    value="{{ isset($i) ? $i->expire_date : ''}}"
                                                                    required  data-format="yyyy/mm/dd"/ ></td>     
-->   
                                                   ...
                                                   <input type="hidden" name="category[]"
                                                                class="form-control item_category{{$i->order_no}}'"
                                                                placeholder="total" required
                                                                value="{{ isset($i) ? $i->category : ''}}" readonly />
                                                        ...
                                                        <tr class="line_items">
                                                            ...
                                                            <td><input type="text" name="subtotal[]"
                                                                    ...
                                                                    jAutoCalc="SUM({total_cost})" readonly class=""></td>
                                                        </tr>
                                                        <tr class="line_items">
                                                            <td colspan="3"></td>
 ...
 <div class="tab-pane fade @if(!empty($serial)) active show @endif" id="importExel" role="tabpanel"
                           ...
                           <div class="card">
                                    <div class="card-header">
                                        @if(empty($serial))
                                        <h5>Create Purchase with Serial</h5>
                                        @else
                                        <h5>Edit Purchase with Serial</h5>
                                        @endif
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($serial))
                                                {{ Form::model($serial, array('route' => array('pharmacy_purchase_serial.update', $serial), 'method' => 'PUT')) }}
                                              
                                                @else
                                                {{ Form::open(['route' => 'pharmacy_purchase_serial.store']) }}
                                                @method('POST')
                                                @endif


                                                <input type="hidden" name="type"
                                                class="form-control name_list"   value="{{ isset($data) ? $edit : ''}}" 
                                                 />
...
<div class="modal fade" id="appFormModal" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="form-group row"><label
        ...
        <div class="modal-footer ">
            <button type="submit" class="btn btn-primary" id="save" onclick="saveSupplier(this)" data-dismiss="modal"><i class="icon-checkmark3 font-size-base mr-1"></i> Save</button>
...
$(document).ready(function() {
    ...
    $(document).on('change', '.item_name', function() {
        ...
        $.ajax({
            url: '{{url("pos/pharmacy_purchases/pharmacy_findInvPrice")}}',
            type: "GET",
            data: {
                id: id
            },
            ...
            success: function(data) {
              ...
              $(".item_category" + sub_category_id).val(data[0]["category"]);
...
$(document).ready(function() {
    ...
    $('.add').on("click", function(e) {
        ...
        html +='<input type="hidden" name="category[]"  class="form-control item_category' + count +'"  placeholder="total" required readonly />';
        ...
        html += '<td><select name="tax_rate[]" class="form-control m-b item_tax' + count +
            '" required ><option value="0">Select Tax</option><option value="0">No tax</option><option value="0.18">18%</option></select></td>';
...
function saveSupplier(e) {
   ...
   var TIN= $('#TIN').val();
          ...
          $.ajax({
            type: 'GET',
            url: '{{url("pos/pharmacy_purchases/addSupplier")}}',
             data: {
                 'name':name,
                 'phone':phone,
                 'email':email,
...
$(document).ready(function() {
    ...
    $(document).on('change', '.sitem_name', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log(data);
                $('.sitem_price' + sub_category_id).val(data[0]["cost_price"]);
...
$(document).ready(function() {
    ...
    $('.sadd').on("click", function(e) {
        ...
        var html = '';
        html += '<tr class="line_items">';
        html +='<td><select name="item_name[]" class="form-control m-b sitem_name" required  data-sub_category_id="' +count +'"><option value="">Select Item Name</option>@foreach($name as $n)<option value="{{ $n->id}}">{{$n->name}}</option>@endforeach</select></td>';
        html +='<td><input type="number" name="quantity[]" class="form-control item_quantity" data-category_id="' +count + '"placeholder ="quantity" id ="quantity" required /></td>';
        html += '<td><input type="text" name="price[]" class="form-control sitem_price' + count +'" placeholder ="price" required  value=""/></td>';
        html += '<td><input type="text" name="unit[]" class="form-control sitem_unit' + count + '" placeholder ="unit" required /></td>';
        ...
        html += '<td><button type="button" name="remove" class="btn btn-danger btn-xs sremove"><i class="icon-trash"></i></button></td>';
