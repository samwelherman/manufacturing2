            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <div class="card row">
                    <div class="card-header">
                        <h4>Purchases Amount With Serial</h4>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('pharmacy_purchase_serial.show',$invoice->id)}}">{{ $invoice->reference_no}}
                                            </a></td>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                @if(isset($id))
                                {{ Form::model($id, array('route' => array('pharmacy_purchase_serial_payment.update', $id), 'method' => 'PUT')) }}
                                @else
                                {{ Form::open(['route' => 'pharmacy_purchase_serial_payment.store']) }}
                                @method('POST')
                                @endif
