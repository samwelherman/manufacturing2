            ...
            <div class="col-12 col-sm-6 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Purchase Serial Report</h4>
                    </div>
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Purchase Serial Report
                                    List</a>
                            </li>
...
?>
                     ...
                     <td>{{$key->serial_no}}</td>
                          ...
                          <td><a  href="#view{{$key->id}}"  data-toggle="modal" onclick="model({{ $key->id }},'purchase')" value="{{ $key->id}}"  data-target="#appFormModal">Create Purchase Warranty</a></td>                                                                                         
                            </tr>
