...
@foreach($data as $key)
 ...
 <tbody>
                    <?php                   
                        $account =App\Models\POS\PurchaseHistory::where('item_id', $key->id)->orderBy('purchase_date','asc')->get();
                        ?>  
 ...
 <?php
                        ...
                        $q = App\Models\POS\PurchaseHistory::where('item_id', $key->id)->sum('quantity');
...
@foreach($data as $key)
 ...
 <?php
                        ...
                        $q = App\Models\POS\InvoiceHistory::where('item_id', $key->id)->sum('quantity');
