...
?>
                     ...
                     <td><a  href="#view{{$key->id}}"  data-toggle="modal" >{{$key->name}}</a></td>
                                     @php
                                      $qty= App\Models\Pharmacy\PurchaseHistory::where('item_id', $key->id)->sum('quantity');   
                                        $total+=$qty;
                                        @endphp 
...
@foreach($data as $key)
 ...
 <tbody>
                    <?php                   
                        $account =App\Models\Pharmacy\PurchaseHistory::where('item_id', $key->id)->orderBy('purchase_date','desc')->get();
                        ?>  
