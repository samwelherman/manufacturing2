                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Sales Report
                                    List</a>
                            </li>
...
?>
                     ...
                     <td><a  href="#view{{$key->id}}"  data-toggle="modal" >{{$key->name}}</a></td>
                                     @php
                                      $qty= App\Models\Pharmacy\InvoiceHistory::where('item_id', $key->id)->where('type', 'Sales')->sum('quantity'); 
                                         $rn= App\Models\Pharmacy\InvoiceHistory::where('item_id', $key->id)->where('type', 'Credit Note')->sum('quantity');   
                                        $total+=$qty;
                                       $return+=$rn;
                                        @endphp 
