           ...
           $name=App\Models\Pharmacy\PurchaseHistory::where('item_id',$i->type)->where('expire_date', '>', $date)->where('added_by',auth()->user()->added_by)->orderBy('expire_date', 'ASC')->get();
                                                        ...
                                                        <tr class="line_items">
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="number" name="quantity[]"
                                                                    ...
                                                                    value="{{ isset($i) ? $i->due_quantity : ''}}"
                                                                    required  />     
                                                                   <div class=""> <p class="class="form-control-static errors{{$i->order_no}}" id="errors" style="text-align:center;color:red;"></p>   </div> 
                                                                         @endif
                                                                           </td>
