...
<div class="head-title">
    <h1 class="text-center m-0 p-0"><img class="pl-lg" style="width: 233px;height: 120px;" src="{{url('public/images/logo.png')}}"> </h1>
</div>
...
<tfoot>
        ...
        <tr>
            <td class="w-50">
               ...
               <img class="pl-lg" style="width: 233px;height: 120px;" src="{{url('public/images/logo.png')}}"> 
                </div>
            </td>
...
<thead>
        <tr>
         ...
         <th class=" col-sm-2 w-50" >Serial/Batch No</th>
...
<tr>
  ...
  <tr>
            <td colspan="5">  </td>
               ...
               <td>{{number_format($gland_total  + $invoices->shipping_cost,2)}}  {{$invoices->exchange_code}}</td> 
