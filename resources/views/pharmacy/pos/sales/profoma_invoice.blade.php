                                                ...
                                                <td>
                                                   @if($row->type == 'Batch')
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('pharmacy_proforma_invoice.show',$row->id)}}" role="tab"
                                            ...
                                            <div class="form-inline">
                                                   @if($row->invoice_status == 0)
                                                    <a class="list-icons-item text-primary"
                                                        ...
                                                        href="{{ route('pharmacy_proforma_invoice.edit', $row->id)}}"><i
                                                            class="icon-pencil7"></i></a>&nbsp
                                                          

                                                    {!! Form::open(['route' => ['pharmacy_proforma_invoice.destroy',$row->id],
                                                    'method' => 'delete']) !!}
                                 ...
                                 &nbsp
                                                ...
                                                <div class="dropdown">
													...
													<div class="dropdown-menu">
                                                       ...
                                                       <a  class="nav-link" onclick="return confirm('Are you sure?')"   href="{{ route('pharmacy_invoice.convert_to_invoice', $row->id)}}"  title="" > Convert To Invoice </a>   

                                                              <a class="nav-link" title="PDF"
                                                                   href="{{ route('pharmacy_proforma_invoice_pdfview',['download'=>'pdf','id'=>$row->id]) }}">Download PDF</a>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('pharmacy_proforma_invoice.update', $id), 'method' => 'PUT',"enctype"=>"multipart/form-data")) }}
                                              
                                                @else
                                                   {!! Form::open(array('route' => 'pharmacy_proforma_invoice.store',"enctype"=>"multipart/form-data")) !!}
                                                @method('POST')
                                                @endif
...
<label class="col-lg-2 col-form-label">Notes</label>
           ...
           $batch_list=App\Models\Pharmacy\PurchaseHistory::where('item_id',$i->type)->where('due_quantity','>','0')->where('expire_date', '>', $date)->where('added_by',auth()->user()->added_by)->orderBy('expire_date', 'ASC')->get();
                                                              $max=App\Models\Pharmacy\PurchaseHistory::where('id', $i->purchase_history)->first();  
                                                              $due=$max->due_quantity;
                                                               }

                                                      else if($i->category == 'Serial'){
                                                            $batch_list=App\Models\Pharmacy\PurchaseSerialList::where('status',0)->where('added_by',auth()->user()->added_by)->get();  
                                                              $due=1; 
                                                            }
                                                              ?>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        ...
                                                        <a class="btn btn-sm btn-danger float-right m-t-n-xs"
                                                            href="{{ route('pharmacy_proforma_invoice.index')}}">
                                                            Cancel
                                                        </a> 
