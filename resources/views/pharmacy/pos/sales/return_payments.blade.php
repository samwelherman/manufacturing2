                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('pharmacy_credit_note.show',$invoice->id)}}">{{ $invoice->reference_no}}
                                            </a></td>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                @if(isset($id))
                                {{ Form::model($id, array('route' => array('pharmacy_credit_note_payment.update', $id), 'method' => 'PUT')) }}
                                @else
                                {{ Form::open(['route' => 'pharmacy_credit_note_payment.store']) }}
                                @method('POST')
                                @endif
