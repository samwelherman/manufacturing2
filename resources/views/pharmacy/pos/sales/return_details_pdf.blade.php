...
<tfoot>
        ...
        <tr>
            ...
            <td class="w-50">
                <div class="box-text">
                   <p> <strong>Reference: {{$invoices->reference_no}}
                      <p> <strong> Return from Invoice No: {{$invoices->invoice->reference_no }}</strong></p>
      <p> <strong>Return Date : {{Carbon\Carbon::parse($invoices->invoice_date)->format('d/m/Y')}}</strong></p>
                </div>
            </td>
        </tr>
</tfoot>
