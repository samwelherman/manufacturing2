            ...
            <div class="col-12 col-sm-6 col-lg-12">
                <div class="card">
                   <div class="card-header header-elements-sm-inline">
                        <h4 class="card-title">Manage Affiliate Users</h4>
                    ...
                    @php $cp_name_list = App\Models\System::where('added_by', $user->added_by)->get()  @endphp
                        <tr>
                         ...
                         <div class="form-inline">
                           <a class="btn btn-outline-info btn-xs edit_user_btn"   href="{{ route('affiliate_users_show', $user->id)}}"><i class="fa fa-edit"></i> View More</a>&nbsp
