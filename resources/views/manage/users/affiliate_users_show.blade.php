...
@section('title')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">
            <strong>Affiliate Users Signed</strong>
        </li>
    </ol>
@endsection
        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-lg-12">
                ...
                <div class="card-body">
                                    ...
                                    <div class="">                            
                                        <p class="form-control-static" style="text-align:center;"><strong>Name Of Affiliator : </strong>{{ $affiliator->name }}</p>
                                    </div>
                                    <div class="">
                                            <p class="form-control-static" style="text-align:center;"><strong>Phone  : </strong>{{ $affiliator->phone }}</p>    
                                    </div>

                                    <div class="">                            
                                        <p class="form-control-static" style="text-align:center;"><strong>Email  : </strong>{{ $affiliator->email }}</p>
                                    </div>

                                    
                
                   <div class="card-header header-elements-sm-inline">
                        <h4 class="card-title">Manage Users Signed By Affiliator</h4>
