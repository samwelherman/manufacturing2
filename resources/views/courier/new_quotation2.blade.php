                            ...
                            <div class="tab-pane fade @if(empty($id)) active show @endif" id="profile2" role="tabpanel"
                                ...
                                <div class="card sales">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                               <form id="addSalesForm" method="post" action="javascript:void(0)">
                                                       @csrf
...
<td><span class="bold">Total</span>: </td><td><input type="text" name="amount[]" class="form-control item_total" placeholder ="total" required   jAutoCalc="{subtotal} + {tax}" readonly></td>  
    ...
    <div class="card pickup" style="display:none;">
                                    <div class="card-header">
                                        <h5>Create Courier Pickup</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">   

             <form id="addPickupForm" method="post" action="javascript:void(0)">
                                                       @csrf
            ...
            <div class="form-group">
                ...
                <div class="col-lg-12">
                    ...
                    <input type="hidden" name="id" value="" required class="form-control pid">
</div>
            </div>
...
<br><div class="form-group row">
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs"
                                                            type="submit" id="pickup" onclick="savePickup(this)">Save</button>
   ...
   <div class="card freight" style="display:none;">
                                    <div class="card-header">
                                        <h5>Create Courier Freight</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">   

             <form id="addFreightForm" method="post" action="javascript:void(0)">
                                                       @csrf
   ...
   <div class="form-group">
       ...
       <br><div class="form-group row">
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs"
                                                            type="submit" id="freight" onclick="saveFreight(this)">Save</button>
...
<div class="card comm" style="display:none;">
                                    <div class="card-header">
                                        <h5>Create Courier Commisssion</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">   

             <form id="addCommForm" method="post" action="javascript:void(0)">
                                                       @csrf
             ...
             <div class="form-group">
                ...
                <input type="hidden" name="id" value="" required class="form-control cid">
                </div>
            </div>
   ...
   <div class="form-group">
        ...
        <br><div class="form-group row">
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs"
                                                            type="submit" id="comm" onclick="saveComm(this)">Save</button>
...
<div class="card delivery" style="display:none;">
                                    <div class="card-header">
                                        <h5>Create Courier Delivery</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">   

                  {{ Form::open(['route' => 'add.delivery']) }}
                                                @method('POST')
                                                       @csrf
 ...
 <div class="form-group">
         ...
         <input type="hidden" name="id" value="" required class="form-control did">
                </div>
            </div>
   ...
   <div class="form-group">
       ...
       <br><div class="form-group row">
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        <button class="btn btn-sm btn-primary float-right m-t-n-xs"
                                                            type="submit" id="delivery" onclick="saveDelivery(this)">Save</button>
