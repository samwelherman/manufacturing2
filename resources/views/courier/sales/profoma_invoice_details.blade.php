        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
               ...
               <div class="col-lg-10">
                 ...
                 <a class="btn btn-xs btn-primary"  onclick="return confirm('Are you sure?')"   href="{{ route('courier_profoma_invoice.edit', $invoices->id)}}"  title="" > Edit </a>          
...
{{--
                ...
                @endif
                   ...
                   @if($invoices->status == 0 && $invoices->invoice_status != 0 )        
              <a class="btn btn-xs btn-info"  title="Convert to Invoice" onclick="return confirm('Are you sure?')"    href="{{ route('invoice.approve',$invoices->id)}}"  title="" >Approve Invoice </a>
                @endif
 ...
 <a class="btn btn-xs btn-success" href="{{ route('courier_profoma_pdfview',['download'=>'pdf','id'=>$invoices->id]) }}"  title="" > Download PDF </a>  
                       ...
                       <th  style="color:white;">Unit</th>
                        ...
                        <th  style="color:white;">Total</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <td class=""><strong class="block">@if(!empty($item_name)) {{$item_name->zone_name}} - {{$item_name->weight}}  @endif</strong>
