                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Courier Freight List </a>
                            </li>
                            @else
                           <li class="nav-item">
                                        ...
                                        <tr>
                                           ...
                                           <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                              ...
                                              <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    style="width: 111.219px;">Date</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 151.219px;">Freight Costs</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 141.219px;">Method</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 181.219px;">Vehicle/AWB</th>
                                                     
                                                    
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="CSS grade: activate to sort column ascending"
                                                    style="width: 188.1094px;">Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @if(!@empty($quotation))
                                            ...
                                            <tr class="gradeA even" role="row">
                                              ...
                                              <td>{{number_format($row->total_freight,2)}} </td>
                                                   <td>{{$row->method}}</td>
                                                <td>
                                                  @if($row->method == 'Air Freight')
                                                       AWB : {{ $row->awb}} 
                                                   @else
                                                 Vehicle : {{ $row->truck_id}} 
                                                      @endif
                                                      </td> 
                                                <td>                                                    
                                            <a href="#" class="nav-link"
                                            data-toggle="modal" data-target="#appFormModal"
                                            data-id="{{ $row->id }}" data-type="freight"
                                            onclick="model({{ $row->id }},'freight')">
                                           View Freight List
                                        </a>
                                                </td>
                                            </tr>
