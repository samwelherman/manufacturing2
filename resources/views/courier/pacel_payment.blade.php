                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('courier.details',$invoice->id)}}">{{ $invoice->pacel_number}}
                                            </a></td>
                                    <td>{{ $invoice->due_amount}} {{ $invoice->currency_code}} </td>
                                    <td> 
                                        @if($invoice->status == 0)
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                @if(isset($id))
                                {{ Form::model($id, array('route' => array('courier_payment.update', $id), 'method' => 'PUT')) }}
                                @else
                                {{ Form::open(['route' => 'courier_payment.store']) }}
                                @method('POST')
                                @endif
