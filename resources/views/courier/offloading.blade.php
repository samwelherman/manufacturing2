...
<?php $id=1; ?>
                                        ...
                                        <tbody>
                                           ...
                                           <td>{{$row->collect->wbn_no}}</td>              
                                             <td> {{$row->start->name}} - {{$row->end->name}}</td>
                                                ...
                                                <td>
                                                    @if($row->status == 4)
                                                    <div class="badge badge-success badge-shadow">Freighted</div>
           ...
           <div class="form-group">
            ...
            <div class="form-group row">
                ...
                <label class="col-lg-2 col-form-label">Destination Date</label>
        ...
        <div class="form-group row">
            <label class="col-lg-2 col-form-label">Collectors</label>
                ...
                <label class="col-lg-2 col-form-label">Agents Cost</label>
