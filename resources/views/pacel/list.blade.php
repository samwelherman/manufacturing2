                                            ...
                                            <tr class="gradeA even" role="row">
                                              ...
                                              <div class="form-inline">
                                                    ...
                                                    <a class="list-icons-item text-primary"
                                                        ...
                                                        href="{{ route('pacel_list.edit', $row->id)}}"><i
                                                            class="icon-pencil7"></i></a>&nbsp
                                                          

                                                    {!! Form::open(['route' => ['pacel_list.destroy',$row->id],
                                                    'method' => 'delete']) !!}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                     @if(isset($id))
                                                {{ Form::model($id, array('route' => array('pacel_list.update', $id), 'method' => 'PUT')) }}
                                                @else
                                                {{ Form::open(['route' => 'pacel_list.store']) }}
                                                @method('POST')
                                                @endif
