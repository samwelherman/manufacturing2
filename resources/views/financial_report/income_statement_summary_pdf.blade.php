...
<!--
  ...
  -->
                       ...
                       <tr>
                        <td colspan="4" style="text-align: left"><b>Expenses</b></td>
...
@foreach($group->accountCodes->where('added_by',auth()->user()->added_by) as $account_code)
 ...
 @endif
  ...
  @endforeach
                    ...
                    <tfoot>
                    <tr>
                         <td colspan="4" style="text-align: left"><b>Profit Before Tax</b></td>
...
?>
                         ...
                         <td colspan=""><b>{{ number_format($profit,2) }}</b></td>
                    </tr>
                     <tr>
...
?>
                        <td colspan="" ><b>{{ number_format($tax,2) }}</b></td>
                    </tr>
                     <tr>
                        <td colspan="4" style="text-align: left">
                            <b>Net Profit</b></td>
                        <td colspan="" ><b>{{ number_format($profit-$tax,2) }}</b></td>
                    </tr>
                    </tfoot>
