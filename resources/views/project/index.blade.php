                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Project
                                    List</a>
                            </li>
                            <li class="nav-item">
                                       ...
                                       <thead>
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    style="width: 121.219px;">Department</th> 
                                         ...
                                         <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                     ...
                                                     <td><a   href="{{ route("project.show",$row->id)}}"> {{$row->project_name}} - {{$row->project_no}}</a></td>
                                                ...
                                                @php $client_name = App\Models\Client::find($row->client_id)->name; @endphp
                                                <td>{{$client_name}}</td> 
...
<a class="list-icons-item text-primary" title="Edit"  href="{{ route("project.edit",$row->id)}}"><i class="icon-pencil7"></i></a>&nbsp
                                                       

                                                            {!! Form::open(['route' => ['project.destroy',$row->id], 'method' => 'delete']) !!}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('project.update', $id), 'method' => 'PUT')) }}
                                                @else
...
@if(!empty($data))
<?php
$list2=explode(",", $data->category_id);
?>
@endif
 ...
 <?php $a=1; ?> 
                                                ...
                                                <div class="form-group row">
                                                 <label class="col-lg-2 col-form-label">Project Category</label>
                                                    <div class="col-lg-6">
                                                     @if(!empty($category))
                                                      <input type="checkbox" name="select_all2"  id="example-select-all2"> Select All <br>
                                            @foreach ($category as $row)
                                    <input name="category_id[]" type="checkbox"  class="checks" value="{{$row->id}}" @if(!empty($data)) <?php if(in_array("$row->id",$list2)){echo "checked";}?> @endif> {{$row->category_name}} &nbsp;
                                            @endforeach
                                                   @endif
