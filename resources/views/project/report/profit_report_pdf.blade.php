...
<tfoot>
        ...
        <tr>
            <td class="w-50">
                <div class="box-text">
                    <center><img class="pl-lg" style="width: 133px;height:110px;" src="{{url('public/assets/img/logo')}}/{{$settings->picture}}"> 
...
<tfoot>
 <td class="w-50">
                <div class="box-text">
                    ...
                    <center><b>   {{ strtoupper($center->project_name) }} - {{ $center->project_no }} for the period: <b>{{Carbon\Carbon::parse($start)->format('d/m/Y')}} to {{Carbon\Carbon::parse($end)->format('d/m/Y')}}</b> </center>
                </div>
        <td>
...
<table class="table  w-100 mt-70" style="width:48%;display: inline-table;">
 <thead>
                        <tr>
 ...
 <tr>
    ...
    <table class="table  w-100 mt-50" style="width:48%;display: inline-table;">
 <thead>
                        <tr>
                            <th> Particulars</th>
                            <th> Amount</th>
