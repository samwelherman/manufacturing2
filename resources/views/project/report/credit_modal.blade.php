    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="formModal">Credit Note Details  for {{$data->project_name}} -  {{$data->project_no}}</h5>
                                       ...
                                       <thead>
                                         ...
                                         <tbody>
                                           @if(!empty($inv))
                                                ...
                                                <td>{{number_format(($row->invoice_amount + $row->invoice_tax) * $row->exchange_rate ,2)}} TZS</td>
     
                                                                    </tr>
                                                                
                                                   <?php $total +=($row->invoice_amount + $row->invoice_tax) * $row->exchange_rate;?>
                                                                                @endforeach                                   
                                                                                @endif
                                            </tbody>
