    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="formModal">Invoice Details  for {{$data->project_name}} -  {{$data->project_no}}</h5>
...
<?php $total=0;?>
            ...
            <div class="table-responsive">
                        ...
                        <?php  $crd=App\Models\JournalEntry::where('project_id', $data->id)->where('transaction_type','pos_invoice')->where('income_id', $row->id)->whereNotNull('debit')->first();  ?>
                                                <td>{{number_format($crd->debit,2)}} TZS</td>
