    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="formModal">Assign User for Project {{$data->project_name}} -  {{$data->project_no}}</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>

 {!! Form::open(array('route' => 'project.assign_user','method'=>'POST', 'id' => 'frm-example' , 'class' => 'frm-example' , 'name' => 'frm-example')) !!}
