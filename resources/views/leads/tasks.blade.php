                         ...
                         <a class="nav-link @if($type == 'details' || $type == 'calls'  || $type == 'meetings'   || $type == 'comments' || $type == 'attachment' || $type == 'tasks' || $type == 'proposal' || $type == 'reminder'  || $type == 'notes' || $type == 'activities') active  @endif" id="home-tab2" data-toggle="tab"
                                                ...
                                                <div class="tab-content tab-bordered" id="myTab3Content">
                                                    <div class="tab-pane fade @if($type == 'details' || $type == 'calls'  || $type == 'meetings'   || $type == 'comments' || $type == 'attachment' || $type == 'tasks' || $type == 'proposal' || $type == 'reminder'  || $type == 'notes' || $type == 'activities') active show  @endif " id="task-home2" role="tabpanel"
                                     ...
                                     <a class="list-icons-item text-primary" title="Edit"  href="{{route('edit.lead_details',['type'=>'edit-tasks','type_id'=>$row->id])}}"><i class="icon-pencil7"></i></a>&nbsp
                                  <a class="list-icons-item text-danger" title="Edit"  href="{{route('delete.lead_details',['type'=>'delete-tasks','type_id'=>$row->id])}}" onclick= "return confirm('Are you sure, you want to delete?')"><i class="icon-trash"></i></a>&nbsp
                                                            ...
                                                            <option value="{{$row->id}}" @if(isset($edit_data))@if($edit_data->category_id == $row->id) selected @endif @endif >{{$row->name}}</option>
                                                             ...
                                                             <div class="input-group-append">
                                                               ...
                                                               <div class="form-group row">
                                                                            ...
                                                                            <div class="col-lg-4">
                                                                                 <select class="m-b" id="milestone_id" name="leads_id">
                                                            <option value="">Select Leads</option>
                                                              @if(!empty($task_leads))                                                      
                                                            @foreach ($task_leads as $row)                                                             
                                                            <option value="{{$row->id}}" @if(isset($edit_data))@if($edit_data->leads_id == $row->id) selected @endif @endif >{{$row->lead_name}}-{{$row->phone}}</option>
                                                               @endforeach
                                                              @endif
                                                             </select>
                                                                            </div>
