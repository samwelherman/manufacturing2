  ...
  <script>
    jQuery(document).ready(function($) {
      $('#example').DataTable(
        ...
        dom: 'Bfrtip',
        buttons: [
                   { extend: 'copy', footer: true, messageTop: '    Class Report.' },
                    
                    { extend: 'excel', footer: true, messageTop: '   Class  Report.' },
                    
                    { extend: 'csv', footer: true, messageTop: '     Class  Report.' },
                    
                   
                    { extend: 'print', footer: true, messageTop: '<center><b>Class Fee  Report.</b></center>' }
                ],
        }
      );
                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Class Report
                                    List</a>
                            </li>
...
<br>
        ...
        <div class="panel-heading">
            <h6 class="panel-title">
                ...
                @if(!empty($class))
                {{ strtoupper($class) }}  Fee Report for the Year {{$year}}</b>
                @endif
            </h6>
        </div>
                        ...
                        <tr>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                          ...
                                          <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="CSS grade: activate to sort column ascending"
                                                    style="width: 128.1094px;">Paid Amount</th>
                                                 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="CSS grade: activate to sort column ascending"
