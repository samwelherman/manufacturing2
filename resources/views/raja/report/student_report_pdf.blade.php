...
<tfoot>
 <td class="w-50">
                <div class="box-text">
                    ...
                    <center><b>   {{ strtoupper($center->student_name) }} Fee Report for the Year {{$year}}</b> </center>
                </div>
        <td>
        ...
        <tr>
            ...
            <td>
                <div class="box-text">
                 ...
                 <p>Email: <a href="mailto:{{$center->email}}">{{$center->email}}</p>
                    <p>TIN : {{!empty($center->TIN)? $center->TIN : ''}}</p>
                </div>
            </td>
        </tr>
</tbody>
