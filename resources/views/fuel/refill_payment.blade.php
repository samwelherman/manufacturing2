                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                @if(isset($id))
                                {{ Form::model($id, array('route' => array('refill_payment.update', $id), 'method' => 'PUT')) }}
                                @else
                                {{ Form::open(['route' => 'refill_payment.store']) }}
                                @method('POST')
                                @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="number" name="amount"
                                            value="{{ $invoice->due_cost}}" class="form-control">

                                            <input type="hidden" name="refill_id"
