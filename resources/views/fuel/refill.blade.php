                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                ...
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Refill
                                    List</a>
                            </li>
                            ...
                            <div class="tab-pane fade @if(empty($id)) active show @endif" id="home2" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                            ...
                                            <tr>
                                              ...
                                              <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 126.484px;">Litres</th>                                              
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                  ...
                                  <a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                    ...
                                    <a class="nav-link"  title="Edit Refill"   data-toggle="modal"  href="#" data-target="#appFormModal" data-id="{{ $row->id }}" data-type="edit_refill"   onclick="model({{ $row->id }},'edit_refill')">Edit Refill  </a>
                                                               @endif

                                                                  @if( $row->status !=2)
                                                            <a class="nav-link" title="Make Payments"
                                                                href="{{ route('refill_payment.show', $row->id)}}" 
                                                              >Make Payments
                                                                    </a>                        
                                                                    @endif
