...
<div class="head-title">
    <h1 class="text-center m-0 p-0">Order Sales</h1>
</div>
...
<thead>
        <tr>
            <th class="col-sm-1 w-50">#</th>
             <th class="col-sm-1 w-50">Type</th>
...
<tr>
        ...
        <div>........................................................</div>
         <div><b> PREPARED BY {{strtoupper($invoices->user->name)}}</div>        
          </div>  </td> 
     ...
     <td style="width: 40%;">
        ...
        <div><b>DATE  :  {{Carbon\Carbon::parse($invoices->invoice_date)->format('d/m/Y')}}</b></div>
