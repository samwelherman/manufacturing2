                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>{{ __('restaurant.menu_item') }}</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
...
<script src="{{ asset('assets/restaurant/select2/dist/js/select2.full.min.js') }}"></script>
    <script src="{{ asset('assets/restaurant/summernote/summernote-bs4.js') }}"></script>
