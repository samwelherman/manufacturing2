                                            ...
                                            @if(!blank(session('variation')))
                                                @foreach(session('variation') as $variation)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="variation[<?=$variation?>][price]" placeholder="{{__('levels.price')}}" class="form-control form-control-sm change-productprice @error("variation.$variation.price") is-invalid @enderror" value="{{ old("variation.$variation.price") }}">
                                                        </td>
                                                        <td>
                                                            <input type="number" name="variation[<?=$variation?>][discount_price]" placeholder="{{__('levels.discount_price')}}" class="form-control form-control-sm change-productdiscountprice @error("variation.$variation.discount_price") is-invalid @enderror" value="{{ old("variation.$variation.discount_price") }}">
                                                        </td>
                                                        <td>
                                            ...
                                            @elseif(!blank($menu_item_variations))
                                                @foreach($menu_item_variations as $menu_item_variation)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="variation[<?=$variation?>][price]" placeholder="{{__('levels.price')}}" class="form-control form-control-sm change-productprice @error("variation.$variation.price") is-invalid @enderror" value="{{ old("variation.$variation.price", $menu_item_variation->price) }}">
                                                        </td>
                                                        <td>
                                                            <input type="number" name="variation[<?=$variation?>][discount_price]" placeholder="{{__('levels.discount_price')}}" class="form-control form-control-sm change-productdiscountprice @error("variation.$variation.discount_price") is-invalid @enderror" value="{{ old("variation.$variation.discount_price",$menu_item_variation->discount_price) }}">
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-danger btn-sm removeBtn">
                                                                <i class="fa fa-trash"></i>
                                            ...
                                            @if(!blank(session('option')))
                                                @foreach(session('option') as $option)
                                                     <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="option[<?=$option?>][price]" placeholder="{{__('levels.price')}}" class="form-control form-control-sm change-productprice @error("option.$option.price") is-invalid @enderror" value="{{ old("option.$option.price") }}">
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-danger btn-sm removeBtn">
                                                                <i class="fa fa-trash"></i>
                                             ...
                                             @elseif(!blank($menu_item_options))
                                                @foreach($menu_item_options as $menu_item_option)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="option[<?=$option?>][price]" placeholder="{{__('levels.price')}}" class="form-control form-control-sm change-productprice @error("option.$option.price") is-invalid @enderror" value="{{ old("option.$option.price", $menu_item_option->price) }}">
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-danger btn-sm removeBtn">
                                                                <i class="fa fa-trash"></i>
