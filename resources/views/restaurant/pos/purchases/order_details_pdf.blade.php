...
<div class="head-title">
    <h1 class="text-center m-0 p-0">@if($purchases->purchase_status == '0') Bar Purchase Requisition @else Bar Purchase Quotation @endif</h1>
</div>
...
<tr>
  ...
  <td style="width: 30%;">
     ...
     <td style="width: 40%;">
            <div class="right" style="">
        <div><b>DATE  : {{Carbon\Carbon::parse($purchases->approval_1_date)->format('d/m/Y')}} </b></div>
