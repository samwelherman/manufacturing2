...
<div class="head-title">
 ...
 <h1 class="text-center m-0 p-0">Purchase Order Payments</h1>
</div>
...
<tbody>
        ...
        <tr>
            ...
            <td>
                <div class="box-text">
                <p>Purchase Reference : {{$purchase->reference_no}}</p>
...
?>
                <td class=""> {{$data->trans_id}}</td>
                                            ...
                                            <td class="">{{ number_format($data->amount ,2)}} {{$purchase->currency_code}}</td>
...
@if(!empty($data->approval_1))
<tr>
         <td style="width: 30%;">
            <div class="left" style="">
        <div>........................................................</div>
         <div><b> CHECKED BY  {{strtoupper($data->first->name)}}</div>        
          </div> </td> 
 ...
 <td style="width: 30%;">
     ...
     <td style="width: 40%;">
            <div class="right" style=""> 
        <div><b>DATE :  {{Carbon\Carbon::parse($data->approval_1_date)->format('d/m/Y')}}</b></div>        
        </div></td>

    </tr>
@endif

@if(!empty($data->approval_2))

<tr>
         <td style="width: 30%;">
            <div class="left" style="">
        <div>........................................................</div>
         <div><b> APPROVED BY  {{strtoupper($data->second->name)}}</div>        
          </div>  </td>
...
<td style="width: 30%;">
     ...
     <td style="width: 40%;">
            <div class="right" style="">
        <div><b>DATE  :  {{Carbon\Carbon::parse($data->approval_2_date)->format('d/m/Y')}}</b></div>
