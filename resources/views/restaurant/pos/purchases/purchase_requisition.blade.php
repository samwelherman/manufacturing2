                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Purchase Requisition
                                     List</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if(!empty($id)) active show @endif" id="profile-tab2"
                                    data-toggle="tab" href="#profile2" role="tab" aria-controls="profile"
                                    aria-selected="false">New Purchase Requisition</a>
                            </li>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('restaurant_purchase.show',$row->id)}}" role="tab"
                                                ...
                                                <td>
                                                    ...
                                                    <a class="list-icons-item text-primary"
                                                        ...
                                                        href="{{ route('restaurant_purchase.edit', $row->id)}}"><i
                                                            class="icon-pencil7"></i></a>&nbsp
                                                         

                                                    {!! Form::open(['route' => ['restaurant_purchase.destroy',$row->id],
                                                    'method' => 'delete']) !!}
   ...
   @endif
                                                <div class="dropdown">
                                                    <a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                                            ...
                                                            @if($row->approval_1 == '' && $row->status == 0)
                         <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="{{ route('restaurant_purchase.first_approval', $row->id)}}">First Approval</a>
                                                           @endif
                                                                @endcan

                                                     @can('manage-second-approval')
                           @if($row->approval_1 != '' && $row->approval_2 == '' && $row->status == 0)
                            <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="{{ route('restaurant_purchase.second_approval', $row->id)}}">Second Approval</a>
                         <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to disapprove')" href="{{ route('restaurant_purchase.second_disapproval', $row->id)}}">Disapprove</a>
                                         @endif
                                               @endcan

                                            @can('manage-third-approval')
                            @if($row->approval_1 != '' && $row->approval_2 != '' && $row->approval_3 == '')
                            <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="{{ route('restaurant_purchase.final_approval', $row->id)}}">Final Approval</a>
                         <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to disapprove')" href="{{ route('restaurant_purchase.final_disapproval', $row->id)}}">Disapprove</a>
                          @endif
                                @endcan

                       <a class="nav-link" id="profile-tab2" href="{{ route('restaurant_purchase_pdfview',['download'=>'pdf','id'=>$row->id]) }}"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('restaurant_purchase.update', $id), 'method' => 'PUT')) }}
                                              
                                                @else
                                                {{ Form::open(['route' => 'restaurant_purchase.store']) }}
                                                @method('POST')
                                                @endif
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        ...
                                                        <a class="btn btn-sm btn-danger float-right m-t-n-xs"
                                                            href="{{ route('restaurant_purchase.index')}}">
                                                            cancel
                                                        </a>
...
$(document).ready(function() {
    ...
    $(document).on('change', '.item_name', function() {
        ...
        $.ajax({
            url: '{{url("restaurant/purchases/findInvPrice")}}',
            type: "GET",
            data: {
                id: id
            },
