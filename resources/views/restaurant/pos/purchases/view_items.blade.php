                                                ...
                                                <table class="table table-bordered" id="cart">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="line_items">
                                                          ...
                                                          <?php
                                                             $due=App\Models\Restaurant\POS\PurchaseHistory::where('purchase_id',$purchase_id)->where('item_id',$i->item_name)->where('type', 'Purchases')->sum('quantity');
                                                         $return=App\Models\Restaurant\POS\PurchaseHistory::where('purchase_id',$purchase_id)->where('item_id',$i->item_name)->where('type', 'Debit Note')->sum('quantity');
                                                          $qty=$due-$return;
                                                              ?>
