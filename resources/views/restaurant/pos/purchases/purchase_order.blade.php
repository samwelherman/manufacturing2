                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Purchase Quotation
                                     List</a>
                            </li>
<!--
                            <li class="nav-item">
                                                ...
                                                <div class="dropdown">
                                                   ...
                                                   @canany(['manage-first-approval', 'manage-second-approval','manage-third-approval'])
                                                            @if( $row->status == 1)
                                                             ...
                                                             <a class="nav-link" id="profile-tab2" data-id="{{ $row->id  }}" data-type="order"   onclick="model({{ $row->id  }},'order')"
