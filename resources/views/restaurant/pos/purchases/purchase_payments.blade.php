                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('restaurant_purchase.show',$invoice->id)}}">{{ $invoice->reference_no}}
                                            </a></td>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                @if(isset($id))
                                {{ Form::model($id, array('route' => array('restaurant_purchase_payment.update', $id), 'method' => 'PUT')) }}
                                @else
                                {{ Form::open(['route' => 'restaurant_purchase_payment.store']) }}
                                @method('POST')
                                @endif
