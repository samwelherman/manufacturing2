...
<div class="add-detail mt-10">
    <div class="w-50 float-left mt-10">
        <p class="m-0 pt-5 text-bold w-100">Reference : <span class="gray-color">{{$invoices->reference_no}}</span></p>
        <p class="m-0 pt-5 text-bold w-100">Invoice Date : <span class="gray-color">{{Carbon\Carbon::parse($invoices->date)->format('d/m/Y')}}</span></p>
