                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('purchase_serial.show',$row->id)}}" role="tab"
                                                ...
                                                <td>
                                                    ...
                                                    <a class="list-icons-item text-primary"
                                                        ...
                                                        href="{{ route('purchase_serial.edit', $row->id)}}"><i
                                                            class="icon-pencil7"></i></a>&nbsp
                                                            @endif

                                                    {!! Form::open(['route' => ['purchase_serial.destroy',$row->id],
                                                    'method' => 'delete']) !!}
...
&nbsp
                                                ...
                                                <div class="dropdown">
                                                    <a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                                            ...
                                                            @if($row->status == 0)
                                                           <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('purchase_serial.approve',$row->id)}}"
                                                                    role="tab"
                                                            ...
                                                            @if($row->status != 0 && $row->status != 4 && $row->status != 3 && $row->good_receive == 0)
                                                             <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('purchase_serial.receive',$row->id)}}"
                                                                    role="tab"
                                                           ...
                                                           <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('purchase_serial.pay',$row->id)}}"
                                                                    role="tab"
                                                            ...
                                                            <a class="nav-link" title="Cancel"
                                                                    ...
                                                                    href="{{ route('purchase_serial.cancel', $row->id)}}">Cancel
                                                                   Purchase</a>
                                        @endif
                                                       </div>
                                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('purchase_serial.update', $id), 'method' => 'PUT')) }}
                                              
                                                @else
                                                {{ Form::open(['route' => 'purchase_serial.store']) }}
                                                @method('POST')
                                                @endif
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        ...
                                                        <a class="btn btn-sm btn-danger float-right m-t-n-xs"
                                                            href="{{ route('purchase_serial.index')}}">
                                                            cancel
                                                        </a>
...
$(document).ready(function() {
    ...
    $(document).on('change', '.item_name', function() {
        ...
        $.ajax({
            url: '{{url("pos/purchases/findSerialInvPrice")}}',
            type: "GET",
            data: {
                id: id
            },
