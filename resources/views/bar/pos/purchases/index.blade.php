                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('store_purchase.show',$row->id)}}" role="tab"
                                                ...
                                                <td>
                                                    ...
                                                    <a class="list-icons-item text-primary"
                                                        ...
                                                        href="{{ route('store_purchase.edit', $row->id)}}"><i
                                                            class="icon-pencil7"></i></a>&nbsp
                                                           

                                                    {!! Form::open(['route' => ['store_purchase.destroy',$row->id],
                                                    'method' => 'delete']) !!}
 ...
 @endif
                                                ...
                                                <div class="dropdown">
                                                    <a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                                            ...
                                                            @if($row->status == 0)
                                                           <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('store_purchase.approve',$row->id)}}"
                                                                    role="tab"
                                                            ...
                                                            @if($row->status != 0 && $row->status != 4 && $row->status != 3 && $row->good_receive == 0)
                                                             <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('store_purchase.receive',$row->id)}}"
                                                                    role="tab"
                                                            ...
                                                            <a class="nav-link" title="Cancel"
                                                                    ...
                                                                    href="{{ route('store_purchase.cancel', $row->id)}}">Cancel
                                                                   Purchase</a>
                                        @endif

                                                            @if($row->status != 0 && $row->status != 4 && $row->status != 3 && $row->good_receive == 1)
                                                           <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('store_purchase.pay',$row->id)}}"
                                                                    role="tab"
                                                                    aria-selected="false">Make Payments</a>
                                                            
                                                            @endif
                                                        <a class="nav-link" id="profile-tab2" href="{{ route('store_purchase_pdfview',['download'=>'pdf','id'=>$row->id]) }}"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('store_purchase.update', $id), 'method' => 'PUT')) }}
                                              
                                                @else
                                                {{ Form::open(['route' => 'store_purchase.store']) }}
                                                @method('POST')
                                                @endif
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-offset-2 col-lg-12">
                                                        ...
                                                        <a class="btn btn-sm btn-danger float-right m-t-n-xs"
                                                            href="{{ route('store_purchase.index')}}">
                                                            cancel
                                                        </a>
...
$(document).ready(function() {
    ...
    $(document).on('change', '.item_name', function() {
        ...
        $.ajax({
            url: '{{url("store/purchases/findInvPrice")}}',
            type: "GET",
            data: {
                id: id
            },
