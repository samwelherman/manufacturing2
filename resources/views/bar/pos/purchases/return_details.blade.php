...
<section class="section">
    <div class="section-body">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
               ...
               <div class="col-lg-10">
                 ...
                 <a class="btn btn-xs btn-primary"  onclick="return confirm('Are you sure?')"   href="{{ route('store_debit_note.edit', $invoices->id)}}"  title="" > Edit </a>          
      ...
      @if($invoices->status == 0 && $invoices->status != 4 && $invoices->status != 3 && $invoices->good_receive == 0)                        
              <a class="btn btn-xs btn-info" data-placement="top"  href="{{ route('store_debit_note.receive',$invoices->id)}}"  title="Good Receive"> Approve Debit Note </a>   
           @endif  
             
             <a class="btn btn-xs btn-success"  href="{{ route('store_debit_note_pdfview',['download'=>'pdf','id'=>$invoices->id]) }}"  title="" > Download PDF </a>         
