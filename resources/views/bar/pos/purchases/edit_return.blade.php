                                                ...
                                                <td>
                                                    <div class="form-inline">
                                                            ...
                                                            <a class="list-icons-item text-primary"
                                                                ...
                                                                href="{{ route('store_debit_note.edit', $row->id)}}"><i
                                                                    class="icon-pencil7"></i></a>&nbsp
                                                                    
        
                                                            {!! Form::open(['route' => ['store_debit_note.destroy',$row->id],
                                                            'method' => 'delete']) !!}
                                         ...
                                         @endif
                                               ...
                                               <div class="dropdown-menu">
                                                                    ...
                                                                    <li> <a class="nav-link" id="profile-tab2"
                                                                            href="{{ route('store_debit_note.receive',$row->id)}}"
                                                                            role="tab"
                                                                    ...
                                                                    <li> <a class="nav-link" id="profile-tab2"
                                                                            href="{{ route('store_debit_note.pay',$row->id)}}"
                                                                            role="tab"
                                                                    ...
                                                                    <li class="nav-item"><a class="nav-link" title="Cancel"
                                                                            ...
                                                                            href="{{ route('store_debit_note.cancel', $row->id)}}">Cancel
                                                                          Credit Note</a></li>
                                                @endif
                                                <a class="nav-link" id="profile-tab2" href="{{ route('store_debit_note_pdfview',['download'=>'pdf','id'=>$row->id]) }}"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('store_debit_note.update', $id), 'method' => 'PUT')) }}
                                              
                                                @else
                                                {{ Form::open(['route' => 'store_debit_note.store']) }}
                                                @method('POST')
                                                @endif
...
console.log(id);
        $.ajax({
            url: '{{url("store/purchases/findinvoice")}}',
            type: "GET",
            data: {
                id: id
            },
...
console.log(id);
        $.ajax({
            url: '{{url("store/purchases/editshowInvoice")}}',
            type: "GET",
            data: {
                id: id,
            },
...
console.log(id);
        $.ajax({
            url: '{{url("store/purchases/findinvQty")}}',
            type: "GET",
            data: {
                id: id,
              item: item,
