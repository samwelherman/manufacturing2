                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('store_invoice.show',$row->id)}}" role="tab"
                                            ...
                                            <div class="form-inline">
                                                    ...
                                                    <a class="list-icons-item text-primary"
                                                        ...
                                                        href="{{ route('store_invoice.edit', $row->id)}}"><i
                                                            class="icon-pencil7"></i></a>&nbsp
                                                           

                                                    {!! Form::open(['route' => ['store_invoice.destroy',$row->id],
                                                    'method' => 'delete']) !!}
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('store_invoice.receive',$row->id)}}"
                                                                    role="tab"
                                                            ...
                                                            <li> <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('store_invoice.pay',$row->id)}}"
                                                                    role="tab"
                                                            ...
                                                            <li class="nav-item"><a class="nav-link" title="Cancel"
                                                                    ...
                                                                    href="{{ route('store_invoice.cancel', $row->id)}}">Cancel
                                                                  Invoice</a></li>
                                        @endif
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('store_invoice.update', $id), 'method' => 'PUT')) }}
                                              
                                                @else
                                                {{ Form::open(['route' => 'store_invoice.store']) }}
                                                @method('POST')
                                                @endif
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <tr class="line_items">
                                                            ...
                                                            <td><input type="number" name="quantity[]"
                                                                    ...
                                                                    required /><div class=""> <p class="form-control-static errors{{$i->order_no}}" id="errors" style="text-align:center;color:red;"></p>   </div>
                                                                </td>
...
$(document).ready(function() {
    ...
    $(document).on('change', '.item_name', function() {
        ...
        $.ajax({
            url: '{{url("store/sales/findInvPrice")}}',
            type: "GET",
            data: {
                id: id
            },
...
<script>
    ...
    console.log(item);
            $.ajax({
                url: '{{url("store/sales/findInvQuantity")}}',
                type: "GET",
                data: {
                    id: id,
                  item: item,
