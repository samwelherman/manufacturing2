                ...
                <div class="col-12 col-md-12 col-lg-12">
                    ...
                    <div class="col-lg-10">
                        ...
                        <a class="btn btn-xs btn-success"
                            href="{{ route('purchase_pdfview', ['download' => 'pdf', 'id' => $purchases->id]) }}" title="">
                            Download PDF </a>
                                ...
                                <div class="tab-pane fade show active" id="about" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-xs-3">
                                            ...
                                            Purchase Date :
                                            {{ Carbon\Carbon::parse($purchases->purchase_date)->format('d/m/Y') }}
                                            <br>Due Date :
                                            {{ Carbon\Carbon::parse($purchases->due_date)->format('d/m/Y') }}
                                    ...
                                    <div class="row mb-lg">
                                        ...
                                        <div class="col-lg-6 col-xs-6">
                                            ...
                                            <br> Email : <a
                                                href="mailto:{{ $purchases->supplier->email }}">{{ $purchases->supplier->email }}</a>
                                            <br>TIN :
                                            {{ !empty($purchases->supplier->TIN) ? $purchases->supplier->TIN : '' }}
                                ...
                                <table class="table items invoice-items-preview" page-break-inside:="" auto;="">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <td colspan="5"></td>
                                            <td>Total Amount</td>
                                            <td>{{ number_format($gland_total - $purchases->discount, 2) }}
                                                {{ $purchases->exchange_code }}</td>
                                        </tr>
                                        ...
                                        @if (!@empty($purchases->due_amount < $purchases->purchase_amount + $purchases->purchase_tax))
                                            <tr>
                                                <td colspan="5"></td>
                                                <td>Paid Amount</p>
                                                <td>{{ number_format($purchases->purchase_amount + $purchases->purchase_tax - $purchases->due_amount, 2) }}
                                                    {{ $purchases->exchange_code }}</p>
                                            </tr>

                                            <tr>
                                                <td colspan="5"></td>
                                                <td class="text-danger">Total Due</td>
                                                <td>{{ number_format($purchases->due_amount, 2) }}
                                                    {{ $purchases->exchange_code }}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @if ($purchases->exchange_code != 'TZS')
                                            ...
                                            <tr>
                                                <td colspan="5"></td>
                                                <td>Total Amount</td>
                                                <td>{{ number_format($purchases->exchange_rate * ($gland_total - $purchases->discount), 2) }}
                                                    TZS</td>
                                            </tr>
                                            ...
                                            @if (!@empty($purchases->due_amount < $purchases->purchase_amount + $purchases->purchase_tax))
                                                <tr>
                                                    <td>Paid Amount</p>
                                                    <td>{{ number_format($purchases->exchange_rate * ($purchases->purchase_amount + $purchases->purchase_tax - $purchases->due_amount), 2) }}
                                                        TZS</p>
                                                </tr>

                                                <tr>
                                                    <td class="text-danger">Total Due</td>
                                                    <td>{{ number_format($purchases->due_amount * $purchases->exchange_rate, 2) }}
                                                        TZS</td>
                                                </tr>
                                            @endif
                                        @endif
