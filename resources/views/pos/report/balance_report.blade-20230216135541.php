...
?>
                        ...
                        @foreach($data as $key)
                           ...
                           <td><a  href="#viewp{{$key->id}}"  data-toggle="modal" >{{number_format($pqty-$dn,2)}}</a></td>
                                <td><a  href="#viewi{{$key->id}}"  data-toggle="modal" >{{number_format($iqty,2)}}</a></td>
                                 <td><a  href="#views{{$key->id}}"  data-toggle="modal" >{{number_format($sqty-$cn,2)}}</a></td>     
                              <td>{{number_format(($pqty-$dn)-($iqty)-($sqty-$cn),2)}}</td>                          
                            </tr>
                     ...
                     <td></td>
                       ...
                       <td>{{number_format(($total_p- $total_pr) - ($total_i) -($total_s- $total_sr),2)}}</td>                               
                            </tr>
                        </tfoot>
                    </table>
