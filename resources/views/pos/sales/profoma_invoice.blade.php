  ...
  <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a class="nav-link" id="profile-tab2"
                                                            href="{{ route('profoma_invoice.show',$row->id)}}" role="tab"
                                              ...
                                              <td>@if(!empty($row->store->name)) {{$row->store->name}} @endif</td>
                                                ...
                                                <td>
                                                   <div class="form-inline">
                                                    ...
                                                    {!! Form::open(['route' => ['profoma_invoice.destroy',$row->id],
                                                    'method' => 'delete']) !!}
						...
						<a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                                      <div class="dropdown-menu">
                                                            ...
                                                            <a  class="nav-link" onclick="return confirm('Are you sure?')"   href="{{ route('invoice.convert_to_invoice', $row->id)}}"  title="" > Convert To Invoice </a>   
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('profoma_invoice.update', $id), 'method' => 'PUT')) }}
                                              
                                                @else
                                                {{ Form::open(['route' => 'profoma_invoice.store']) }}
                                                @method('POST')
                                                @endif
                                                        ...
                                                        <tr class="line_items">
                                                          ...
                                                          <td><input type="number" name="quantity[]"
                                                                   class="form-control item_quantity" data-category_id="{{$i->order_no}}"
                                                                    ...
                                                                    required /><div class=""> <p class="form-control-static errors{{$i->order_no}}" id="errors" style="text-align:center;color:red;"></p>   </div></td>
                                                            ...
                                                            <input type="hidden" id="item_id"  class="form-control item_id{{$i->order_no}}" value="{{$i->items_id}}" />
...
<div class="modal fade" data-backdrop="" id="appFormModal" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="form-group row"><label
        ...
        <div class="modal-footer bg-whitesmoke br">
            <button type="submit" class="btn btn-primary" onclick="saveSupplier(this)" data-dismiss="modal">Save</button>
