                                                        ...
                                                        <tr class="gradeA even" role="row">
                                                            ...
                                                            <td>
                                                                <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('invoice.show', $row->id) }}"
                                                                    role="tab"
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-12 ">
                                                    @if (isset($id))
                                                        {{ Form::model($id, ['route' => ['invoice.update', $id], 'method' => 'PUT']) }}
                                                    @else
                                                            ...
                                                            <select class="form-control m-b location" name="location"
                                                                ...
                                                                @if (!empty($location))
                                                                    @foreach ($location as $loc)
                                                                        <option
                                                                            @if (isset($data)) {{ $data->location == $loc->location_id ? 'selected' : '' }} @endif
                                                            ...
                                                            <div class="col-md-6  id="bank_id" style="display: block">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control m-b" name="bank_id">
                                                                        <option value="">Select Payment Account
                                                                        </option>
                                                                    ...
                                                                    @if (!empty($items))
                                                                        ...
                                                                        selected @endif
                                                                                ...
                                                                                <td><select name="tax_rate[]"
                                                                                        ...
                                                                                        required>
                                                                                        <option value="0">Select Tax
                                                                                            Rate</option>
                                                                                        <option value="0"
                                                                                            @if (isset($i)) @if ('0' == $i->tax_rate) selected @endif
                                                                                            @endif>No
                                                                                            tax</option>
                                                                                        <option value="0.18"
                                                                                            @if (isset($i)) @if ('0.18' == $i->tax_rate) selected @endif
                                                                                            @endif>18%
                                                                                        </option>
                                                                                    </select></td>
                ...
                <div class="modal-content">
                    ...
                    <form id="addClientForm" method="post" action="javascript:void(0)">
                        ...
                        <div class="modal-footer bg-whitesmoke br">
                            <button type="submit" class="btn btn-primary" onclick="saveSupplier(this)"
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '.item_name1', function() {
                var id = $(this).val();
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '.item_quantity1', function() {
                var id = $(this).val();
