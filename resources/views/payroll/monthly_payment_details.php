               ...
               <div class="panel panel-custom">
                    <div class="panel-heading">
                      ...
                      <table class="table datatable-basic table-borderless">
                              ...
                              <tr><td><strong>Total Deductions  </strong></td><td><?php echo number_format( $total_advance +$total_deduction  +$total_loan + $salary_info->fine_deduction, 2) ?></td> </tr>                                       
                             <tr><td><strong>Net Salary   </strong></td><td><?php echo number_format(($total_salary +   $total_award + $total_amount + $salary_grade_info->salaryTemplates->basic_salary)-($total_advance +$total_deduction +$total_loan + $salary_info->fine_deduction)  , 2) ?></td> </tr>                                      
