               ...
               <div class="panel panel-custom">
                 ...
                 <table class="table datatable-basic table-borderless">
                        ...
                        <tr><td><strong>Basic Salary  </strong></td><td><?php echo number_format($salary_grade_info->salaryTemplates->basic_salary, 2) ?></td></tr>                                                                                                  
                              ...
                              <tr><td><strong>Gross Salary  </strong></td><td><?php echo number_format($total_salary + $salary_grade_info->salaryTemplates->basic_salary, 2) ?></td> </tr>                                      
                              <tr><td><strong>Total Deductions  </strong></td><td><?php echo number_format($total_deduction, 2) ?></td> </tr>                                       
                             <tr><td><strong>Net Salary   </strong></td><td><?php echo number_format(($total_salary + $salary_grade_info->salaryTemplates->basic_salary)-$total_deduction  , 2) ?></td> </tr>                                      
                            </table>
