    ...
    public function store(Request $request)
    {
        ...
        if(($receipt['amount'] <=  $sales->due_amount)){
            ...
            if( $receipt['amount'] > 0){
                ...
                $data['paid_amount'] = $sales->paid_amount + $receipt['amount'];
...
$balance=$payment->amount;
   ...
   // save into tbl_transaction
                ...
                return redirect(route('retail_invoice.index'))->with(['success'=>'Payment Added successfully']);
            }else{
                return redirect(route('retail_invoice.index'))->with(['error'=>'Amount should not be equal or less to zero']);
            }
       

        }else{
            return redirect(route('retail_invoice.index'))->with(['error'=>'Amount should  be less than Invoice amount ']);
    ...
    public function edit($id)
    {
        ...
        return view('retail.pos.sales.invoice_payments',compact('invoice','payment_method','data','id','bank_accounts'));
    }
