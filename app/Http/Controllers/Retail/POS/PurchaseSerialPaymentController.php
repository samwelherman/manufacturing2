...
$balance=0-$payment->amount;
   ...
   // save into tbl_transaction
                ...
                return redirect(route('retail_purchase_serial.index'))->with(['success'=>'Payment Added successfully']);
            }else{
                return redirect(route('retail_purchase_serial.index'))->with(['error'=>'Amount should not be equal or less to zero']);
            }
       

        }else{
            return redirect(route('retail_purchase_serial.index'))->with(['error'=>'Amount should  be less than Purchase amount ']);
...
$balance=0-$receipt['amount'];
 ...
 // save into tbl_transaction
                ...
                return redirect(route('retail_purchase.index'))->with(['success'=>'Payment Added successfully']);
            }else{
                return redirect(route('retail_purchase.index'))->with(['error'=>'Amount should not be equal or less to zero']);
            }
       

        }else{
            return redirect(route('retail_purchase.index'))->with(['error'=>'Amount should  be less than Purchase amount ']);
