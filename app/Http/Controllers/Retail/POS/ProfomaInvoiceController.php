...
class ProfomaInvoiceController extends Controller
{
    ...
    $location =  Location::where('added_by',auth()->user()->added_by)->get();;
        $region =Region::all();
         $edit="";
        $item_type="";
       return view('retail.pos.sales.profoma_invoice',compact('name','client','currency','invoices','item_type','edit','s_name','bank_accounts','location','region'));
    }
    ...
    public function store(Request $request)
    {
       ...
       if(!empty($invoice)){
        ...
        return redirect(route('retail_proforma_invoice.show',$invoice->id));
    ...
    public function show($id)
    {
        ...
        return view('retail.pos.sales.profoma_invoice_details',compact('invoices','invoice_items','payments'));
    }
    ...
    public function edit($id)
    {
      ...
      $location =  Location::where('added_by',auth()->user()->added_by)->get();;
       ...
       return view('retail.pos.sales.profoma_invoice',compact('name','client','currency','data','id','items','item_type','edit','s_name','bank_accounts','location','region'));
    }
    ...
    public function update(Request $request, $id)
    {
       ...
       if($request->item_type == 'receive'){
        ...
        if(!empty($invoice)){
            ...
            return redirect(route('retail_proforma_invoice.show',$id));
  ...
  public function inventory_list()
    ...
    public function invoice_pdfview(Request $request)
    {
        ...
        $pdf = PDF::loadView('retail.pos.sales.profoma_invoice_pdf')->setPaper('a4', 'potrait');
