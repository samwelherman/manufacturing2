...
class InvoiceSerialController extends Controller
{
    ...
    public function index()
    {
      ...
      $bank_accounts=AccountCodes::where('account_group','Cash and Cash Equivalent')->get(); 
       return view('retail.pos.sales.invoice',compact('name','client','currency','invoices','type','edit','bank_accounts'));
    }
    ...
    public function store(Request $request)
    {
       ...
       $shipArr =  str_replace(",","",$request->shipping_cost);
        ...
        return redirect(route('retail_serial_invoice.show',$invoice->id));
    ...
    public function show($id)
    {
        ...
        return view('retail.pos.sales.invoice_serial_details',compact('invoices','invoice_items','payments'));
    }
    ...
    public function edit($id)
    {
      ...
      $type="";
        //$bank_accounts=AccountCodes::where('account_group','Cash and Cash Equivalent')->where('added_by',auth()->user()->added_by)->get(); 
      $bank_accounts=AccountCodes::where('account_group','Cash and Cash Equivalent')->get();  
       return view('retail.pos.sales.invoice',compact('s_name','name','client','currency','data','s_items','type','edit','serial','bank_accounts'));
    }
...
$balance=$payment->amount;
   ...
   // save into tbl_transaction
            ...
            return redirect(route('retail_serial_invoice.show',$id));
  ...
  public function findBatch(Request $request)
   ...
   public function discountModal(Request $request)
    ...
    //$bank_accounts=AccountCodes::where('account_group','Cash and Cash Equivalent')->where('added_by',auth()->user()->added_by)->get(); 
      $bank_accounts=AccountCodes::where('account_group','Cash and Cash Equivalent')->get();
       return view('retail.pos.sales.invoice',compact('name','s_name','client','currency','data','serial','s_items','type','edit','bank_accounts'));;
    }
  ...
  public function inventory_list()
    ...
    public function make_payment($id)
    {
        ...
        $bank_accounts=AccountCodes::where('account_group','Cash and Cash Equivalent')->get() ;
        return view('retail.pos.sales.invoice_serial_payments',compact('invoice','payment_method','bank_accounts'));
    }
    ...
    public function invoice_pdfview(Request $request)
    {
        ...
        $pdf = PDF::loadView('retail.pos.sales.invoice_serial_details_pdf')->setPaper('a4', 'potrait');
    ...
    public function note_pdfview(Request $request)
    {
        ...
        if($request->has('download')){
        $pdf = PDF::loadView('retail.pos.sales.invoice_serial_note_pdf')->setPaper('a4', 'potrait');
