...
class PurchaseSerialController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('retail_purchase_serial.show',$purchase->id));
    ...
    public function show($id)
    {
        ...
        return view('retail.pos.purchases.purchase_serial_details',compact('purchases','purchase_items','payments'));
    }
    ...
    public function edit($id)
    {
       ...
       $edit="";
   $type="";
       return view('retail.pos.purchases.index',compact('name','supplier','currency','location','data','s_items','serial','edit','type'));
    }
        ...
        if($inv->purchase_tax > 0){
         ...
         $journal->added_by=auth()->user()->added_by;
          ...
          $journal->save();
            ...
            return redirect(route('retail_purchase_serial.show',$id));
 ...
 public function addSupplier(Request $request){
   ...
   public function discountModal(Request $request)
                 ...
                 $type = $request->type;
                  if($type == 'reference'){
                   $data=PurchaseSerialList::find($request->id);
                    return view('retail.pos.purchases.addreference',compact('id','data'));
      }

          else{
                   $data=PurchaseHistory::find($request->id);
                    return view('retail.pos.purchases.addbatch',compact('id','data'));
      }
                 }
    ...
    public function approve($id)
    {
        ...
        $data['status'] = 1;
        $purchase->update($data);
        return redirect(route('retail_purchase.index'))->with(['success'=>'Approved Successfully']);
    }
    ...
    public function make_payment($id)
    {
        ...
        return view('retail.pos.purchases.purchase_serial_payments',compact('invoice','payment_method','bank_accounts'));
    }
    ...
    public function inv_pdfview(Request $request)
    {
        ...
        $pdf = PDF::loadView('retail.pos.purchases.purchase_serial_details_pdf')->setPaper('a4', 'potrait');
 ...
 public function list()
    {
       ...
       return view('retail.pos.purchases.list',compact('list'));
    }
           ...
           public function save_reference (Request $request){
                     ...
                     return redirect(route('retail.list'))->with(['success'=>'Inventory Reference Assigned Successfully']);
                 }
}
