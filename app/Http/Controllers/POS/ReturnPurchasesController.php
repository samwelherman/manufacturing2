 ...
 if(!empty($return)){
    ...
    public function destroy($id)
    {
       ...
       'user_id'=>auth()->user()->id,
        ...
        return redirect(route('debit_note.index'))->with(['success'=>'Deleted Successfully']);
    }
   ...
   public function findPrice2(Request $request)
    {
               $price=  Purchase::where('supplier_id', $request->id)->where('good_receive', 1)->where('status',1)->where('project_id',$request->project)->get();               
                return response()->json($price);                      
    ...
    public function approve($id)
    {
     ...
     if(!empty($invoice)){
       ...
       'user_id'=>auth()->user()->id,
        ...
        return redirect(route('debit_note.index'))->with(['success'=>'Approved Successfully']);
    }
    ...
    public function cancel($id)
    {
     ...
     $inv=Purchase::find($invoice->purchase_id);
       ...
       'user_id'=>auth()->user()->id,
        ...
        return redirect(route('debit_note.index'))->with(['success'=>'Cancelled Successfully']);
    }
