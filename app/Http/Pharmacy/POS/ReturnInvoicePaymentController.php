...
$balance=0-$payment->amount;
   ...
   // save into tbl_transaction
                            ...
                            return redirect(route('pharmacy_credit_note.index'))->with(['success'=>'Payment Added successfully']);
                        }else{
                         
                            return redirect(route('credit_note.index'))->with(['error'=>'Amount should not be equal or less to zero']);
                        }
                   
            
                    }else{
                      
                            return redirect(route('credit_note.index'))->with(['error'=>'Amount should  be less than Invoice amount']);
